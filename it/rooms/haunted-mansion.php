...
<section class="container-fluid room-choco text-center " id="mainsect">
  ...
  <div id="rooms" class="mt-5" style="display: flex;align-items: center;justify-content:center;">
    ...
    <p class="room-desc" style="">A horror room, with intensive atmosphere and scary jump-scares. <br/>Sound and Visual effects combination increase the player’s experience.
    </p>
...
<div class="right-icon"></div>
    ...
    <p class=" story" style="">You are a team of the most experienced “investigators of the supernatural” .
A mysterious man approached you, offering a huge amount of money,
to go inside and search for a powerful ancient Artifact.
He didn’t avoid to tell you that all the previous he hired, never came back.</p>
  </div>
