...
<body id="page-top">
            ...
            <div class="dropup-container" style="margin-top:-2px;">
                ...
                <div id="mySidenav" class="sidenav nav navbar-nav" style="overflow:hidden;"> <button class="closebtn">&times;</button>
                    ...
                    <div class="" style="display: flex;justify-content: center;align-items: center;padding-bottom:40px;font-size:13px;">
                        <ul class="text-left">
                            <div class="lang"> <img style="border-radius:50%;align-self: center;width:13px;" src="/img/flags/en.svg" alt="GAME OVER - English"> <a href="/rooms/illuminati.php">English</a> </div>
    ...
    <?php include '../../inc/carousel-illuminati.php'; ?>

    <section class="container-fluid illuminati text-center " id="mainsect">
        ...
        <div class="info-container" style="">
            ...
            <p class="room-desc" style="">
                Hai l’occasione di svelare i segreti più nascosti del complotto degli Illuminati e trovare il<br/>
                leggendario Sacro Graal. Una trama spettacolare e un gameplay appassionante, incluse partite<br/>
                tecnologicamente avanzate, sono gli ingredienti vincenti di questa stanza.
            </p>
    ...
    <script src="/rooms/boot-custom.js"></script> <!-- Custom scripts for this template -->
