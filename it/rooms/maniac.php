...
<head>
  ...
  <meta name="description" content="Maniac: I Want To Play a Game | Ispirata alla famosa serie di film,

     questa stanza risveglierà tutto il tuo istinto di sopravvivenza ">
  ...
  <meta property="og:url" content="https://www.escapegameover.com/it/rooms/maniac.php" />
  ...
  <meta name="twitter:title" content="Maniac: I Want To Play a Game | GAME OVER Escape Rooms " />
...
<body id="page-top">
          ...
          <div class="" style="display: flex;justify-content: center;align-items: center;padding-bottom:40px;font-size:13px;">
            ...
            <ul class="text-left">
              ...
              <div class="lang">
                ...
                <a href="../../fr/rooms/maniac.php">French</a>
  ...
  <section class="container-fluid room-maniac text-center " id="mainsect">
    ...
    <div class="info-container" style="padding-top:50px;">
      ...
      <p class="room-desc" style="">Ispirata alla famosa serie di film,<br>

        questa stanza risveglierà tutto il tuo istinto di sopravvivenza</p>
      ...
      <p class=" story" style="">Ti svegli in un posto buio e cominci a guardare intorno...

        Improvvisamente una voce dice: "Voglio fare un gioco..."

        Ti trovi nella camera della morte di Jigsaw e sai che tutto è contro di te.

        La tua unica possibilità di sopravvivere è seguire le sue pazze missioni e trovare il momento giusto per scappare! Il tempo scorre...</p>
