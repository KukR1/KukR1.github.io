...
<head>
  ...
  <meta name="description" content="Tutankhamun's Tomb | Questa stanza è una riproduzione fedele dell'interno

di un'antica piramide egizia.
...
Una stanza molto avanzata dal punto di vista scenografico e tecnologico. ">
  ...
  <meta property="og:url" content="https://www.escapegameover.com/it/rooms/tutankhamuns-tomb.php" />
  ...
  <meta name="twitter:title" content="Tutankhamun's Tomb | GAME OVER Escape Rooms " />
         ...
         <button class="closebtn" >&times;</button>
            ...
            <div class="" style="display: flex;justify-content: center;align-items: center;padding-bottom:40px;font-size:13px;">
              ...
              <div class="lang">
                    ...
                    <a href="../../rooms/tutankhamuns-tomb.php">English</a>
...
<?php include '../../inc/carousel-tutankhamuns-tomb.php'; ?>
...
<section class="container-fluid room-tut text-center " id="mainsect">
  ...
  <div class="info-container" style="">
    ...
    <p class="room-desc" style="">Questa stanza è una riproduzione fedele dell'interno

di un'antica piramide egizia.<br>
...
<div class="right-icon"></div>
    ...
    <p class=" story" style="">Ti trovi nella sala principale. Se apri questa porta puoi scoprire il segreto del grande Faraone.  Ma fai attenzione! Se rimani qui per più di un'ora,

la sua maledizione cadrà per sempre su di te.</p>
