...
<head>
  ...
  <meta name="description" content="Forbidden Temple of Montezuma | La stanza è una fedele riproduzione di un antico
     tempio azteco nella giungla. Un gioco allettante, un sacco di tecnologia dietro
     le quinte ed una scenografia a tema di alta qualità rendono questa sala unica">
  ...
  <meta property="og:url" content="https://www.escapegameover.com/it/rooms/montezuma.php" />
  ...
  <meta name="twitter:title" content="Forbidden Temple of Montezuma | GAME OVER Escape Rooms " />
         ...
         <button class="closebtn" >&times;</button>
            ...
            <div class="" style="display: flex;justify-content: center;align-items: center;padding-bottom:40px;font-size:13px;">
              ...
              <div class="lang">
                    ...
                    <a href="../../rooms/montezuma.php">English</a>
                  </div>
                  <div class="lang">
...
<!-- carousel -->
<?php include '../../inc/carousel-montezuma.php'; ?>
<!-- end of carousel -->
<section class="container-fluid room-monte text-center " id="mainsect">
  ...
  <div class="info-container" style="padding-top:50px;">
    ...
    <p class="room-desc" style="">La stanza è una fedele riproduzione di un antico <br>
       tempio azteco nella giungla. Un gioco allettante, un sacco di tecnologia dietro <br>
       le quinte ed una scenografia a tema di alta qualità rendono questa sala unica
    </p>
...
<div class="right-icon"></div>
    ...
    <p class=" story" style="">Sono passati molti anni da quando il tuo professore
alla Scuola di Archeologia è scomparso. Avevate preso l'impegno reciproco di portare alla luce la sua ricerca sugli Aztechi! Dunque ora ti trovi qui, a seguire le sue tracce ben criptate... Ma attenzione... quello che ha provocato la sua perdita potrebbe perseguitarti...
    </p>
  </div>
