...
<section class="container-fluid arkham text-center " id="mainsect">
  ...
  <div class="info-container" style="">
    ...
    <p class="room-desc" style="">Traendo ispirazione dai migliori fumetti gialli decò,

    Arkham Prison pone i giocatori contro le menti criminali che dirigono la città.
    ...
    <div class="room-icon" style="">
       ...
       <div class="small-box text-center" style="">
          ...
          <img src="../../img/menus_logo/puzzle.svg" alt="Puzzles and riddles"alt="Puzzles and riddles">
...
<div class="right-icon"></div>
    ...
    <p class=" story" style="">Durante le Rivolte di Arkham Prison uno dei supercriminali più pericolosi è riuscito a fuggire dalla sua cella. Se il suo piano ha un esito positivo, questo avrà conseguenze devastanti per l’intera città. Tu e la tua squadra siete la nostra ultima speranza: dovete entrare nella prigione, raccogliere gli indizi lasciati dietro e mettere fine a questa follia prima che sia troppo tardi./p>
