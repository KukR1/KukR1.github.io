...
<head>
  ...
  <title>La misión del profesor | GAME OVER Escape Rooms</title>
  <meta name="keywords" content="" />
  <meta name="description" content="LA MISIÓN DEL PROFESOR  | Be a member of the famous crew, to complete the Money Heist, Robbing the National Mint.<br>
Avoid the security , and print as much money as you can.  ">
  ...
  <meta property="og:title" content="La misión del profesor | GAME OVER Escape Rooms" />
  <meta property="og:url" content="https://www.escapegameover.com/it/rooms/la-mision-del-profesor.php" />
  ...
  <meta name="twitter:title" content="La misión del profesor | GAME OVER Escape Rooms " />
...
<body id="page-top">
          ...
          <div class="" style="display: flex;justify-content: center;align-items: center;padding-bottom:40px;font-size:13px;">
            <ul class="text-left">
              <div class="lang">
                ...
                <a href="../../rooms/la-mision-del-profesor.php">English</a>
              </div>
              <div class="lang">
  ...
  <!-- carousel -->
  <?php include '../../inc/carousel-la-mision-del-profesor.php'; ?>
  <!-- end of carousel -->
  ...
  <section class="container-fluid room-jacknew text-center " id="mainsect">
    ...
    <div class="info-container" style="">
      ...
      <div id="rooms" class="" style="display: flex;align-items: center;justify-content:center;padding-top:50px;">
        ...
        <h1 style="display:inline-block;line-height:2rem;font-size:2.5rem;text-align:left;">LA MISIÓN</h1>
      </div>
      <p class="room-desc" style="">Entra a far parte della famosa squadra per completare Money Heist, Robbing the National Mint.<br>
        Evitate il servizio di sicurezza e stampate più denaro che potete.
      </p>
      ...
      <p class=" story" style=""> Sarà il furto più clamoroso di tutti i tempi, quindi indossate maschere e uniformi e dimostratevi all’altezza della situazione.<br>
        Il piano è stato progettato fin nei minimi particolari e il denaro è lì che vi aspetta, ma quando le porte della Zecca di stato si chiuderanno,
        la vostra squadra verrà messa a dura prova.<br>
        Riuscirete a rimanere uniti nonostante una pressione opprimente e delle difficili scelte oppure vi dividerete e sarete in gioco ciascuno contro tutti?<br>
        Il piano del Professore è già stato messo in atto e il pericolo maggiore lo rappresenti proprio tu.
    </div>
    </div>
