...
<head>
  ...
  <meta name="description" content="Phantazma - Medieval castle | Questa stanza può essere fornita in due diverse modalità. La modalità CASTELLO MEDIEVALE

     riguarda una storia medievale in un castello misterioso. La modalità FANTASMA si svolge in una torre oscura,

      spaventosa e abbandonata, con molte strane voci su di essa. ">
  ...
  <meta property="og:url" content="https://www.escapegameover.com/it/rooms/phantazma.php" />

  <meta property="og:site_name" content="GAME OVER Escape Rooms " />

  <meta property="og:image" coroom_slider_images/phantazma (5).jpgm/img/fb-logo.png" />

  <meta property="og:image:secure_url" content="https://www.escapegameover.com/img/fb-logo.png" />

  <meta name="twitter:card" content="summary" />

  <meta name="twitter:title" content="Phantazma - Medieval castle | GAME OVER Escape Rooms " />
         ...
         <button class="closebtn" >&times;</button>
            ...
            <div class="" style="display: flex;justify-content: center;align-items: center;padding-bottom:40px;font-size:13px;">
              ...
              <div class="lang">
                    ...
                    <a href="../../rooms/phantazma.php">English</a>
...
<?php include '../../inc/carousel-phantazma.php'; ?>
...
<section class="container-fluid room-phantazma text-center " id="mainsect">
  ...
  <div class="info-container" style="padding-top:50px;">
    ...
    <p class="room-desc" style="">Questa stanza può essere fornita in due diverse modalità. La modalità CASTELLO MEDIEVALE <br>

       riguarda una storia medievale in un castello misterioso. La modalità FANTASMA si svolge in una torre oscura,<br>

        spaventosa e abbandonata, con molte strane voci su di essa.<br>



Può anche accogliere un ruolo per attore dal vivo
...
<div class="right-icon"></div>
    ...
    <p class=" story" style=""> Voci e leggende ti hanno portato qui! I diari di quelli che ci hanno provato prima si fermano qui, ricordi? Dalla Cittadella di Saladino si sono trasferiti nel deserto,  in una torre di avamposto, dove la leggenda dice che è scomparso l'ultimo fondatore dell'Ordine dei Templari! Nessuno è tornato per confermare le dicerie...

Sotto il chiaro di luna, le carovane del deserto vedono luci ad un miglio di distanza e pensano che la torre sia infestata da fantasmi, ma gli anziani credono ancora che il Crοciato era un Demone e che è ancora VIVO!</div>
