...
<head>
  ...
  <meta name="description" content="Space Wars | Un gioco di fuga all'interno di un'astronave realistica.

Caratteristiche e giochi estremamente avanzati dal punto di vista tecnologico,

persino un vero videogioco, realizzato con fattori sopresa ed effetti speciali">
  ...
  <meta property="og:url" content="https://www.escapegameover.com/it/rooms/space-wars.php" />
  ...
  <meta name="twitter:title" content="Space Wars | GAME OVER Escape Rooms " />
...
<body id="page-top">
  ...
  <section class="container-fluid room-space text-center " id="mainsect">
    ...
    <div class="info-container" style="">
      ...
      <p class="room-desc" style="">Un gioco di fuga all'interno di un'astronave realistica.<br>

        Caratteristiche e giochi estremamente avanzati dal punto di vista tecnologico,<br>
      ...
      <p class=" story" style="">Sono passati due anni da quando Lancer 19A è scomparso e la guerra per il controllo della galassia è diventata una guerra per proteggere il nostro pianeta dall'invasione.

        Lancer 19A era il bastione della Flotta spaziale della Battaglia Terrestre,

        quando misteriosamente le sue tracce furono perse... fino alla settimana scorsa! Lancer è stato visto nel mezzo di un Campo Asteroide e EBSF ha mandato in una capsula spaziale te e la tua squadra per recuperare l'astronave, indagare i motivi della sua scomparsa e volare lontano dagli asteroidi per tornare sulla Terra!</p>
