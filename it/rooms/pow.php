...
<head>
  ...
  <meta name="description" content="Prisoners of War | Una stanza a tema militare. I giocatori devono scappare

    prima da una cella di prigionia e poi da un'intera base militare, passando attraverso tutte le 15 fasi">
  ...
  <meta property="og:url" content="https://www.escapegameover.com/it/rooms/pow.php" />
  ...
  <meta name="twitter:title" content="Prisoners of War | GAME OVER Escape Rooms " />
...
<body id="page-top">
          ...
          <div class="" style="display: flex;justify-content: center;align-items: center;padding-bottom:40px;font-size:13px;">
            ...
            <ul class="text-left">
              ...
              <div class="lang">
                ...
                <a href="../../rooms/pow.php">English</a>#contact_form
  ...
  <section class="container-fluid room-pow text-center " id="mainsect">
    ...
    <div class="info-container" style="padding-top:50px;">
      ...
      <p class="room-desc" style="">Una stanza a tema militare. I giocatori devono scappare <br>

        prima da una cella di prigionia e poi da un'intera base militare, passando attraverso tutte le 15 fasi</p>
      ...
      <p class=" story" style="">Eri in missione in Corea del Nord dietro le linee nemiche.

        Qualcosa è andato storto, il tuo gruppo ha perso il contatto con l'unità ed è stato catturato dalle forze nemiche. Ora sei un prigioniero di guerra! Usa le tue abilità SERF (sopravvivenza, evasione, resistenza e fuga) per poter tornare nella giungla e rientrare in azione.
