                ...
                <div id="mySidenav" class="sidenav nav navbar-nav" style="overflow:hidden;"> <button class="closebtn">&times;</button>
                    ...
                    <div class="" style="display: flex;justify-content: center;align-items: center;padding-bottom:40px;font-size:13px;">
                        <ul class="text-left">
                            ...
                            <div class="lang"> <img style="border-radius:50%;align-self: center;width:13px;" src="/img/flags/gr.svg" alt="GAME OVER - Greek"> <a href="/gr/rooms/horror-circus.php">Greek</a> </div>
    ...
    <section class="container-fluid circus text-center " id="mainsect">
        ...
        <div class="info-container" style="">
            <div id="rooms" class="" style="display: flex;align-items: center;justify-content:center;padding-top:50px;"> <img src="/img/svg/circus.svg" classs="img-fluid" alt="" style="width: 5rem;height:5rem;">
                <h1 style="display:inline-block;line-height:5rem;font-size:3rem;">CIRCO DEGLI ORRORI</h1>
            </div>
            <p class="room-desc" style="">
                Un escape game in stile horror all’interno di un circo maledetto, pieno di effetti spaventosi e dall’atmosfera esaltante.<br />
                Tecnologie all’avanguardia ed elementi strabilianti racchiusi in una fantastica scenografia che sarà<br />
                un vero successo tra studenti e adulti.
            </p>
