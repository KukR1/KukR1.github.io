...
<head>
  ...
  <meta name="description" content="Necromancy | Da qualche parte in città, esiste una vecchia casa che tutti evitano.

Gli spiriti che vi sono imprigionati sono eternamente immersi in un incubo senza fine. ">
  ...
  <meta property="og:url" content="https://www.escapegameover.com/it/rooms/necromancy.php" />
  ...
  <meta name="twitter:title" content="Necromancy | GAME OVER Escape Rooms " />
...
<body id="page-top">
  ...
  <section class="container-fluid room-necro text-center " id="mainsect">
    ...
    <div class="info-container" style="padding-top:50px;">
      ...
      <p class=" story" style="">Da qualche parte in città, esiste una vecchia casa che tutti evitano.

        Gli spiriti che vi sono imprigionati sono eternamente immersi in un incubo senza fine. Tuttavia, non dovresti solo esplorare l'antica dimora,

        ma anche chiamare le anime perdute dal loro macabro letargo,

        anche se questo significa praticare l'arte proibita della Necromanzia.

        Quello che scoprirai lì non lo sa nessuno, dal momento che nessuno

        è tornato vivo, o perfino morto, da questa casa...</p>
    ...
    <div class="" style="padding-bottom: 30px;">
      ...
      <p>* Necessario personaggio dal vivo</p>
