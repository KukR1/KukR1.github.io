...
<head>
  ...
  <meta name="description" content="Top Secret | Un gioco di fuga di spionaggio, in cui i giocatori

    devono scappare da una prigione e rubare Documenti

    Top Secret irrompendo nel caveau ad alta sicurezza ">
  ...
  <meta property="og:url" content="https://www.escapegameover.com/it/rooms/top-secret.php" />
  ...
  <meta name="twitter:title" content="Top Secret | GAME OVER Escape Rooms " />
...
<body id="page-top">
          ...
          <div class="" style="display: flex;justify-content: center;align-items: center;padding-bottom:40px;font-size:13px;">
            ...
            <ul class="text-left">
              ...
              <div class="lang">
                ...
                <img style="border-radius:50%;align-self: center;width:13px;" src="../../img/flags/en.svg" alt="GAME OVER - English" #contact_form <a href="../../rooms/top-secret.php">English</a>
  ...
  <?php include '../../inc/carousel-top-secret.php'; ?>
  ...
  <section class="container-fluid room-top text-center " id="mainsect">
    ...
    <div class="info-container" style="">
      ...
      <p class="room-desc" style="">Un gioco di fuga di spionaggio, in cui i giocatori <br>

        devono scappare da una prigione e rubare Documenti <br>
      ...
      <p class=" story" style="">L'unico modo per entrare nel quartier generale paramilitare è

        lasciare che le guardie ti arrestino e portino in prigione.

        Ed eccoti qui dunque! Ora devi scappare dalla prigione e irrompere

        nel caveau blindato ad alta sicurezza per rubare i loro progetti sul missile XJ7 e tutto il loro archivio top secret. Sbrigati!
