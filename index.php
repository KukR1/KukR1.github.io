...
<body id="page-top">
      ...
      <div class="burger-flag" style="">
         ...
         <div class="dropup-container">
            ...
            <div id="mySidenav" class="sidenav nav navbar-nav" style="overflow:hidden;">
               ...
               <p class="text-center" style="color:white;font-size:17px;margin:25px 0;font-weight:300;width:100%;">
                  CHOOSE LANGUAGE</p>
               <div style="display: flex;justify-content: center;align-items: center;padding-bottom:40px;font-size:13px;">
                  <ul class="text-left">
                     <div class="lang">
   ...
   <section id="main1" class="background-section" style="">
      ...
      <!-- <div class="wedesign-box">
            <div class="wedesign-inner-box">
               <picture>
                  <img style="transform: rotate(-4deg);" class="animated anim anim2 img-fluid" sizes="(max-width: 2520px) 100vw, 2520px" srcset="
                     img/home_page/wedesign/wedesign_nswtx3_c_scale,w_320.png 360w,
                     img/home_page/wedesign/wedesign_nswtx3_c_scale,w_911.png 911w,
                     img/home_page/wedesign/wedesign_nswtx3_c_scale,w_1347.png 1347w,
                     img/home_page/wedesign/wedesign_nswtx3_c_scale,w_1725.png 1725w,
                     img/home_page/wedesign/wedesign_nswtx3_c_scale,w_2520.png 2520w" src="wedesign_nswtx3_c_scale,w_2520.png" alt="">
               </picture>
               <p style="text-align:center;margin-top:25px;">design. construct. get locked. escape.</p>
   ...
   <section id="sect1" class=" container-fluid text-center">
      <div class="second-box">
         <img src="img/menus_logo/aboutus.svg" alt="Come with us" style="width:45px;height:45px;">
         <h2>COME WITH US</h2>
         <div class="paragraph-container">
            <p class="fade1 fadeIn animated">fascinating experience, high quality scenes,
               <br /> cutting edge technologies, unique riddles & puzzles.
            </p>
            <p class="fade2 fadeIn animated inv">GAME OVER Escape Rooms design and create premium quality, themed escape
               games. We aim in a fascinating, realistic player experience, as we combine high quality scenes with
               cutting edge technologies and unique riddles and puzzles attached to the storyline. In addition our “new
               age” Marketing Services will help you to keep your business on top level. As a result of the continuous
               research aiming the innovation in our field, the quality of our Products and our special Marketing Plan,
               GAME OVER Escape Rooms consist one of the leading Escape Game companies worldwide.</p>
         </div>
   ...
   <section id="sect2" class="container-fluid text-center">
      <div class="second-box">
         <img src="img/menus_logo/search.svg" alt="About escape rooms" style="width:45px;height:45px;">
         <h2>ABOUT ESCAPE ROOMS</h2>
         <div class="paragraph-container">
            <p class="fade1 fadeIn animated">the worldwide trend of entertainment</p>
            <p class="fade2 fadeIn animated inv">ESCAPE ROOMS are interactive, really fascinating games that can put
               someone into a role according to the scenario. The goal of the game is to solve a number of riddles, find
               hidden objects and clues so the players can solve the mystery and escape from the room on time. ESCAPE
               GAMES have become a worldwide trend of entertainment over the last few years, gaining fans that integrate
               these games in their daily activity of entertainment, called escape gamers.</p>
         </div>
         <div class="text-center" style="margin:10px 0;">
                     ...
                     <div class="col-12 col-md-6">
                        ...
                        <a href="rooms/philosophers-stone.php" title="">
                           <div class="image-info-container" style="">
                              ...
                              <h3 style="text-align:left;">PHILOSOPHER'S <br class="mb-br"> STONE</h3>
                           </div>
                        </a>
                     </div>
                  </div>
                     ...
                     <div class="col-12  col-md-6 " style="position:relative;">
                        ...
                        <a href="rooms/jtr-the-revenge.php" title="">
                           <div class="image-info-container" style="">
                              <img style="" src="img/svg/jack.svg" alt="">
                              <h3>JACK <br> THE RIPPER <br><span id="revenge">THE REVENGE</span> </h3>
                              <img src="img/newera.svg" style="width:32px;margin-left:10px;">
                           </div>
                        </a>
                     </div>
                     <div class="col-12  col-md-6">
   ...
   <section id="map-section" class="content-section text-center" style="">
      ...
      <div id="svg-desk" style="">
         <div class="map-box" style="">
            ...
            <h2>NETWORK</h2>
            <p>GAME OVER around the world</p>
            <div class="text-center" style="margin:10px 0;">
               <a href="gallery.php" style="font-size: 1rem;font-weight: 600;letter-spacing: -0.01rem;background: transparent;color: white;border: transparent;">See
                  all<span style="position: relative;left: 0.4rem;">&gt;</span></a>
            </div>
         </div>
         <?php
         include "map_svg/map_com.svg";
         ?>
      </div>
      <div id="svg-mobile" style="margin:0 auto;">
         <div class="map-box1">
            ...
            <p>GAME OVER around the world</p>
            <div class="text-center" style="margin:10px 0;">
               <a href="gallery.php" style="font-size: 1rem;font-weight: 600;letter-spacing: -0.01rem;pointer-events: all;background: transparent;color: white;border: transparent;">See
                  all<span style="position: relative;left: 0.4rem;">&gt;</span></a>
            </div>
         </div>
         <?php
   ...
   <section id="whatwedo" class="lazy container-fluid text-center">
      <div style="display:flex;width:100%;align-items:center;justify-content:center;">
         <div class="third-box">
            ...
            <h2>WHAT WE O<span style="margin-left:2px;">F</span>FER</h2>
      ...
      <div class="container-fluid whatwedo-container" style="">
         <div class=" text-center offer-box">
            ...
            <p>We design & create premium quality, state of the art themed Escape Games.</p>
         </div>
         <div class=" text-center offer-box">
            <a href="gallery.php">
               <div>
            ...
            <p>We can be available in any country worldwide.</p>
         </div>
         <div class=" text-center offer-box">
            ...
            <p>We train your people how to operate the games and we provide game & maintenance manuals.</p>
         </div>
         <div class=" text-center offer-box">
            <div>
            </div>
       ...
       <!--   <div class=" text-center offer-box"> -->
        ...
        <!--  </div> -->
         <div class=" text-center offer-box">
            ...
            <p>Autohelp Hint System is an automated way to control and guide the players in the room without having one
               Game Master operating each room.</p>
         </div>
         <div class=" text-center offer-box">
            <div>
            </div>
            <p>Join now our worldwide Escape Rooms network and take advantage of the GAME OVER distinctive brand ID.</p>
         </div>
         <div class=" text-center offer-box">
            <div>
            </div>
   ...
   <footer style="margin-bottom:40px;">
      <section class="footer1 content-section">
         <div class="ul-container" style="display:flex;width: 100%;">
            <div class="footer-flex" style="">
               ...
               <ul class="company1" style="text-align:right;">
                  <li class="site-li-header">ABOUT US</li>
         ...
         <div class="ul-container" style="display:flex;width: 100%;">
            <div class="footer-flex" style="border-bottom: none;">
               ...
               <ul class="company1" style="text-align:right;">
                  <!-- <li class="site-li-header">MEMBER OF</li>
                  <li><a href="company/presentation.pdf" download>Company Presentation </a></li>
                  <li><a href="statements.html">Financial Statements </a></li>
                  <li><a href="terms.html">Terms and Conditions </a></li>
      ...
      <script src="https://www.googletagmanager.com/gtag/js?id=UA-87676239-1"></script>
      <script>
