      ...
      if ($(window).width() < 768) {
         setTimeout(function() {
            $("video source").each(function() {
               ...
               //   $(this).attr("src", sourceFile);
               var sourceFile = "../img/4years_mobile.mp4";
               $(this).attr("src", sourceFile);
               var video = this.parentElement;
               video.load();
               video.play();
...
<body id="page-top">
   ...
   <!--<section id="main1" class="background-section" style="">-->
   <!---->
   <!--<video  class="" id="bgvid " playsinline autoplay muted loop>-->
   <!---->
   <!--<source src=" " type="video/mp4 ">-->
   <!--</video>-->
   <!--<div class="wedesign-box">-->
   <!--    <div class="wedesign-inner-box" >-->
   <!--    <img class="animated anim anim2 img-fluid" src="../img/home_page/wedesign.png" alt="" style="transform: rotate(-4deg);">-->
   <!--<p style="text-align:center;margin-top:25px;">design. construct. get locked. escape.</p>-->
   <!--<a class="js-scroll-trigger" href="#sect1">-->
   <!--            <div class="text-center arrow-button" style="">-->
   <!--                    <p>&lt;</p>-->
   ...
   <section id="sect1" class=" container-fluid text-center">
      <div class="second-box">
         <img src="../img/menus_logo/aboutus.svg" alt="Komm mit uns" style="width:45px;height:45px;">
         <h2>KOMM MIT UNS</h2>
         <div class="paragraph-container">
            <p class="fade1 fadeIn animated">GAME OVER Räume gestalten und produzieren hochqualitäts- völlig thematisiert, <br>
               einzigartige Fluchtspiele,
               die dem potentiellen Käufer zur Verfügung <br> gestellt werden können, entweder mit unserem.</p>
            <p class="fade2 fadeIn animated inv">Markennamen GAME OVER und die Perspektiven,
               die mit einer dauerhaften Zusammenarbeit kommen, oder können einfach nur Räume von GAME OVER erstellt werden , mit der Verwendung des Markennamen des Käufers.

               Als Ergebnis der konsequenten Forschung,mit Ziel die Innovation in unserem Bereich und den speziellen Marketingplan,
               der unsere Marke GAME OVER definiert, laden wir Sie, uns in eine ehrgeizige und Gewinn bringende Karriere zu folgen.



               Wir suchen Mitarbeiter aus der ganzen Welt, um unser Netzwerk und die Erfahrung von Flucht-Spielen zu entwickeln.</p>
   ...
   <section id="sect2" class="container-fluid text-center">
      <div class="second-box">
         <img src="../img/menus_logo/search.svg" alt="ÜBER FLUCHTRÄUME" style="width:45px;height:45px;">
         <h2>ÜBER FLUCHTRÄUME</h2>
         <div class="paragraph-container">
            <p class="fade1 fadeIn animated">Fluchträume sind interaktive, wirklich faszinierende Spiele, <br>
               die jemanden in eine Rolle nach dem Szenarium bringen können.</p>
            <p class="fade2 fadeIn animated inv">Das Ziel des Spiels ist, eine Reihe von Rätseln zu lösen, versteckte Objekte zu finden und die Spieler hinzuweisen, so dass sie das Rätsel lösen und aus dem Raum pünktlich zu fliehen.



               Flucht Spiele sind zu einem weltweiten Trend der Unterhaltung in den letzten Jahren geworden, Fans, die diese Spiele in ihrer täglichen Aktivität der Unterhaltung integrieren, genannt als Flucht-Spieler.</p>
         </div>
         <div class="text-center" style="margin:10px 0;">
   ...
   <section class="  container-fluid text-center" id="scenarios">
      <img src="../img/menus_logo/scenarios.svg" alt="SZENARIUM" style="width:45px;height:45px;">
      <h2>SZENARIUM</h2>
                     ...
                     <div class='col-md-3 col-12'>
                        <div class="image-box" title="">
                           ...
                           <picture>
                              ...
                              <source type="image/jpeg" srcset="../img/mobile_thumbs/choco.jpg" media="(max-width: 769px)">
   ...
   <section id="map-section" class="content-section text-center" style="">
      ...
      <div id="svg-desk" style="">
         <div class="map-box" style=""> <img src="../img/menus_logo/clients.svg" alt="Our clients from around the world" style="width:45px;height:45px;">
            <h2>NETWORK</h2>
   ...
   <section id="whatwedo" class="lazy container-fluid text-center">
      ...
      <div class="container-fluid whatwedo-container" style="">
         <div class=" text-center offer-box">
            ...
            <p>Wir entwerfen und erstellen erstklassige, thematische Flucht-Spiele.</p>
         </div>
         <div class=" text-center offer-box">
            <a href="gallery.php">
               <div class="">
            ...
            <p>Wir können in jedem Land weltweit verfügbar sein.</p>
         </div>
         <div class=" text-center offer-box">
            ...
            <p>Wir schulen Ihre Mitarbeiter bei der Bedienung der Spiele, wir stellen Ihnen Spiel- und Wartungshandbücher zur Verfügung.</p>
         </div>
         <div class=" text-center offer-box">
            <div class="">
         ...
         <div class=" text-center offer-box">
            ...
            <p>Autohelp Hint System ist ein automatisierter Weg, um die Spieler im Raum zu steuern und zu steuern, ohne dass ein Game Master jeden Raum bedient.</p>
         </div>
         <div class=" text-center offer-box">
            <div class="">

            </div>
            <p>Sie können Ihr eigenes Logo und Handelsnamen verwenden oder verwenden Sie id und marketing Kits.</p>
         </div>
         <div class=" text-center offer-box">
            <div class="">

            </div>
            <p>Der Beitritt zu unseren Marketing-Dienstleistungen bietet Ihnen eine extreme IT- und dedizierte Artwork-Unterstützung.</p>
         </div>
      </div>
         ...
         <div class="ul-container" style="display:flex;    width: 100%;">
            <div class="footer-flex" style="">
               ...
               <ul class="company1" style="text-align:right;">
                  <li class="site-li-header">KOMM MIT UNS</li>
            ...
            <div class="footer-flex2" id="foot-dest">
               <ul class="contact1" style="text-align:left;">
                  <li class="site-li-header">KONTAKTIERE UNS</li>
