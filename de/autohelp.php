  ...
  <section id="autohelp_main" class="container-fluid text-center">
    ...
    <div class="autohelp-box">
      ...
      <p>AHS ist ein automatisierter Weg,<br> um die Spieler im Raum zu steuern und zu führen. <br>Die Hauptidee von <span style="font-weight:700;">AHS</span> ist,
        ...
        der an die Szenografie angehängt ist. Der größte Vorteil des Autohelp Hint-Systems besteht darin,

        dass der Kunde die Lohnkosten des Personals entscheidend reduziert, da es keine Notwendigkeit gibt,
