...
<section class="container-fluid" style="">
  ...
  <div class="container p-5" >
    ...
    INFORMATION NOTICE ON THE PROTECTION OF PERSONAL DATA</h2>
<p>
...
<p>
<span style="font-size:20px;">1. Data Processing Manager and Data Protection Officer </span><br><br>
The Data Processing Manager is  "ESCAPE GAME OVER IKE",
based in Megalou Alexandrou 55, Argyroupoli , Athens . You may contact
 the Data Protection Officer ("DPO") at the following
 address: <a href="mailto: gdpr@escapegameover.com">gdpr@escapegameover.com</a>.
</p>
<p>
<span style="font-size:20px;">2. The Data We Process</span><br><br>
...
personal data you provide when interacting with the website and using
 ...
 the name and surname, contact details, the content of your specific
  requests or references and the additional data the Data Processing Manager
   can obtain, including from third parties, in the course of his business.<br>
  ...
  his own legitimate interests and in all cases provided for in Articles
   6 and 9 of the GDPR Regulation.<br>
...
<p>
<span style="font-size:20px;">3.Why and how we process your data</span><br><br>

The data shall be processed for the following purposes:<br><br>
...
<i>
  -to handle your requests to provide information through the website
   ...
   is your consent (Article 6 (1) (a) and Article 9 (2) (a) of the GDPR Regulation)</i><br><br>
<i> -to manage reports of side effects submitted through the website or the contact
  or booking form. The legal basis for processing for these purposes
  is your consent (Article 6 (1) (a) and Article 9 (2) (a) of the GDPR Regulation).</i><br>
...
-To receive advertising material (direct marketing) from the Company.</i><br>

By selecting the appropriate frames you agree to process your data for these purposes.<br>
...
legitimate claims in the Company's interest.<br>
...
<p>
<span style="font-size:20px;">4. People who have access to the data</span><br><br>
...
and are accessible by the personnel of the Data Processing Manager authorized to
 ...
 employees belonging to the following categories: technical staff,
  IT staff and administrative staff, product managers as well as other
   staff members who have to process the data to carry out their duties.<br>
   Data may also be shared in countries outside the European Union: <br><br>i) institutions, authorities, public bodies for institutional purposes
  <br><br>ii) professional, independent consultants - whether employed individually
  ...
  the Data Processing Manager with the commercial, professional or technical services
   required for the operation of the website (e.g. providing IT and Cloud Computing )
    ...
    in providing the services you have requested.<br><br>iii) to third parties in the case of mergers, acquisitions,
    transfers of undertakings or their branches, controls
     or other exceptional operations.<br><br>
...
<p>
<span style="font-size:20px;">5. Your rights</span><br><br>
...
<h2 class="text-center"> PRIVACY POLICY CONCERNING THE USE OF THE WEBSITE</h2>


<p> The company "ESCAPE GAME OVER IKE", which is based in Megalou Alexandrou 55, Argyroupoli , Athens
takes very seriously the privacy of users and undertakes to fully comply with the applicable
law (Regulation (EU) 2016/679 - hereafter "GDPR").

This Privacy Policy ("Privacy Policy") provides information on how to process personal data collected
by the Company through this site (https://escapegameover.com) and constitutes an informational notice
to the data subject in accordance with Article 13 of the GDPR Regulation. Special informational
 disclosures about the confidentiality of information are usually published in the sections
 of the Website where the user's personal data is collected and are in any case supplemented
 by this Privacy Policy.
</p>
<p>
<span style="font-size:20px;"> Data Processing Manager and Data Protection Officer</span><br><br>
The  Data Processing Manager is ESCAPE GAME OVER IKE,
based in Megalou Alexandrou 55, Argyroupoli , Athens. You can contact the Data Protection Officer ("DPO") at the
following address <a href="mailto: gdpr@escapegameover.com">gdpr@escapegameover.com</a> .
</p>
<p>
<span style="font-size:20px;">The Data We Process</span><br><br>
The following data can be processed:<br>
...
<p>
<span style="font-size:20px;">Why and how we process your personal data</span><br><br>
...
Article 6 (1) (c) of the GDPR Regulation. <br>
...
The legal basis for processing for this purpose is Article 6 (1) (a) of the GDPR Regulation.<br>
...
data to protect its rights in court proceedings. All of your data is processed using automated
 and online tools that are appropriate to ensure full security and confidentiality.<br>
</p>

<p>
<span style="font-size:20px;">Necessary processing and optional editing</span><br><br>
...
<p>
<span style="font-size:20px;">Browsing data</span><br><br>
...
<p>
<span style="font-size:20px;">Links to other sites</span><br><br>
...
<p>
<span style="font-size:20px;">How we store the data and for how long</span><br><br>
...
<p>
<span style="font-size:20px;">How do we ensure the security and quality of your personal information</span><br><br>
...
<p>
<span style="font-size:20px;">People who have access to the data</span><br><br>
...
<p>
<span style="font-size:20px;">Your rights </span><br><br>
