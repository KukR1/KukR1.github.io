    ...
    <section class="container-fluid circus text-center " id="mainsect">
        ...
        <div class="info-container" style="">
            <div id="rooms" class="" style="display: flex;align-items: center;justify-content:center;padding-top:50px;"> <img src="/img/svg/circus.svg" classs="img-fluid" alt="" style="width: 5rem;height:5rem;">
                <h1 style="display:inline-block;line-height:5rem;font-size:3rem;">HORROR-ZIRKUS</h1>
            </div>
            <p class="room-desc" style="">
                Ein Horror-Fluchtspiel in einem heimgesuchten Zirkus, voll gruseliger Effekte und aufregendem Ambiente.</br>
                Spitzentechnologie und Wow-Faktoren in einer großartigen Szenografie machen diesen Raum bei</br>
                Studenten und Erwachsenen sehr beliebt.
            </p>
