...
<head>
  ...
  <meta name="description" content="Space Wars | Ein Fluchtspiel in einem realistischen Raumschiff. Extrem technologisch fortgeschrittene Funktionen und Spiele, <br>

    sogar ein echtes Videospiel, das mit echten Wow-Faktoren und Spezialeffekten ins reale Leben gebracht wurde.">
  ...
  <meta property="og:url" content="https://www.escapegameover.com/de/rooms/space-wars.php" />
...
<body id="page-top">
          ...
          <div class="" style="display: flex;justify-content: center;align-items: center;padding-bottom:40px;font-size:13px;">
            ...
            <ul class="text-left">
              ...
              <div class="lang">
                ...
                <a style="align-items:center;" href="../../gr/rooms/space-wars.php">Greek</a>
              ...
              <div class="lang">
                ...
                <a href="../../it/rooms/space-wars.php">Italian</a>
  ...
  <section class="container-fluid room-space text-center " id="mainsect">
    ...
    <div class="info-container" style="">
      ...
      <p class="room-desc" style="">Ein Fluchtspiel in einem realistischen Raumschiff. Extrem technologisch fortgeschrittene Funktionen und Spiele, <br>

        sogar ein echtes Videospiel,

        das mit echten Wow-Faktoren und Spezialeffekten ins reale Leben gebracht wurde.
      ...
      <section class="icon-section">
        ...
        <div class="room-icon" style="">
          ...
          <div class="small-box text-center" style="">
            ...
            <p>REQUIRED <br> SPACE</p>

            <p class="pdesc">5x8m</p>
      ...
      <p class=" story" style="">Zwei Jahre sind vergangen, seit Lancer 19A verschwunden ist und der Krieg um die Kontrolle der Galaxis zu einem Krieg geworden ist, um unseren Planeten vor einer Invasion zu schützen. Lancer 19A war die Bastion die Weltraum-Schlachtflotte (EBSF) der Erde, als ihre Spur auf mysteriöse Weise verloren ging ... bis letzte Woche, wo die Spur wieder auftauchte! Lancer wurde in der Mitte eines Asteroidenfeldes gesichtet und ihr seid das Team, das EBSF in eine Raumkapsel schickt, um das Raumschiff zurückzuholen, die Gründe für sein Verschwinden zu erforschen und sicher aus den Asteroiden und zurück zur Erde zu fliegen!</p>
