  ...
  <section class="container-fluid room-aztec text-center " id="mainsect">
    ...
    <div class="info-container" style="">
      ...
      <p class="room-desc" style="">
        ...
        Dieses Zimmer bietet eine komplette erweiterte Erfahrung, auf einem riesigen Raum> 85 Quadratmeter.<br>

        Es gibt viele visuelle und akustische Effekte,

        physische Hindernisse <br>zu durchlaufen und sehr detaillierte, qualitativ hochwertige Set-Designs.<br>

        Dieser Raum kann in 60 'oder 90' Version gespielt werden und kann auch als Live-Schauspieltheater gespielt werden.
      ...
      <p class=" story" style="">
        ...
        Nach den Hinweisen, die Ihr Partner und Professor hinterlassen hat, sind Sie aufgerufen, ein Geheimnis zu lüften

        niemand könnte Jahrhunderte lang knacken und etwas entdecken, das die gesamte menschliche Geschichte, so wie wir sie kennen, verändern wird! Die Briefe, die jeder von euch gestern Abend erhielt, waren alle identisch,

        aber schließlich Licht in den Fall des Vermissten für 6 Jahre, Professor Robert Jackson.

        Die Karte, die dem Brief beigefügt war, führte Sie tief in Amazonien, den am wenigsten erforschten und abgelegensten Teil des Dschungels.
