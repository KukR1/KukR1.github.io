...
<body id="page-top">
  ...
  <?php include '../../inc/carousel-philosophers-stone.php'; ?>
  ...
  <section class="container-fluid philosopher text-center " id="mainsect">
    ...
    <div class="info-container" style="">
      ...
      <p class="room-desc" style=""> Ein Fluchtspiel-Abenteuer, inspiriert von der berühmten Filmreihe. <br>

        Eine Kombination aus technologisch fortgeschrittenen Features und Spielen, <br>

        zahlreichen Wow-Faktoren und visuellen Effekten, die in realen Bedingungen ein einzigartiges Erlebnis bieten.
      ...
      <p class=" story" style="">Der Dunkle ist erwacht. Nur die Macht des Steines der Weisen,

        versteckt in einer geheimen Kammer voller gefährlicher Magie und gefahrvollem Zauber,

        kann seiner Schreckensherrschaft ein Ende setzen. Du und dein Team müssen den Stein zurückholen und die

        aufkommende Dunkelheit besiegen, sonst geht alles verloren. Beeilt euch, denn die Zeit ist nicht auf eure Seite,

        sondern auf die der Zauberer und Hexen </p>
