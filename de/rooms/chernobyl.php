...
<head>
  ...
  <meta name="description" content="Chernobyl | Ein Abenteuer in einem alten, verlassenen Reaktor, <br>verbirgt sich eine Menge Geheimnisse, Rätsel und Technik, um die Spieler entkommen zu lassen.">
  ...
  <meta property="og:url" content="https://www.escapegameover.com/de/rooms/chernobyl.php" />
  ...
  <style media="screen">
    ...
    .room-reactor::after {
      ...
      background: url("../../img/room_slider_images/reactor7.jpg") no-repeat center center;
...
<body id="page-top">
          ...
          <div class="" style="display: flex;justify-content: center;align-items: center;padding-bottom:40px;font-size:13px;">
            ...
            <ul class="text-left">
              ...
              <div class="lang">
                ...
                <a href="../../rooms/chernobyl.php">English</a>
  ...
  <?php include '../../inc/carousel-chernobyl.php'; ?>
  ...
  <section class="container-fluid room-reactor text-center " id="mainsect">
    ...
    <div class="info-container" style="">
      ...
      <p class="room-desc" style="">Ein Abenteuer in einem alten, verlassenen Reaktor, <br>verbirgt sich eine Menge Geheimnisse, Rätsel und Technik, um die Spieler entkommen zu lassen.
      ...
      <p class=" story" style=""> Dieses Jahr haben Sie und Ihre Freunde beschlossen, für Ihre jährliche Urlaubsreise,<br>

        in einer Hütte tief in den Krakauer Wald zu fahren. Der erste Tag war ein wenig langweilig, <br>

        aber dann entdeckte einer von euch einen verlassenen Reaktor in den Wäldern. Heute Abend sind Sie bereit,<br>

        das faszinierendste Abenteuer Ihres Lebens zu leben, so dass Sie die Fabrik betreten, die nicht so tot ist wie sie scheint.<br>

        Ihr Abenteuer wird ein Rennen, um von diesem gruseligen Ort BALDMÖGLICHST zu entkommen! Vorsicht!<br>

        Der verfügbare Sauerstoff reicht für eine Stunde so … beeilen Sie sich.</p>
