...
<head>
  ...
  <title>Jack The Ripper | GAME OVER Escape Rooms</title>

  <meta name="keywords" content="" />

  <meta name="description" content=" Jack The Ripper | London, 1888. Ein weiterer Mord geschah in dieser Nacht,

     auch in Whitechappel. Der Ripper schlägt wieder und die Leute sind erschrocken,

      fast niemand ist auf der Straße. Außer dir. Wenn die Hinweise, die Sie in Ihren Händen haben korrekt sind,

       wird heute Abend alles enden. Oder Nein? Es liegt an Ihnen… ">
  ...
  <meta property="og:title" content="Jack The Ripper | GAME OVER Escape Rooms" />

  <meta property="og:url" content="https://www.escapegameover.com/de/rooms/jack-the-ripper.php" />
...
.room-jack {
  ...
  .room-jack::after {
    ...
    background:url("../../img/room_slider_images/ripper (2).jpg") no-repeat center center ;
         ...
         <button class="closebtn" >&times;</button>
            ...
            <div class="" style="display: flex;justify-content: center;align-items: center;padding-bottom:40px;font-size:13px;">
              ...
              <div class="lang">
                    ...
                    <a href="../../rooms/jack-the-ripper.php">English</a>
                  ...
                  <div class="lang">
                    ...
                    <a style="align-items:center;" href="../../gr/rooms/jack-the-ripper.php">Greek</a>
                  ...
                  <div class="lang">
                    ...
                    <a href="../../it/rooms/jack-the-ripper.php">Italian</a>
                  ...
                  <div class="lang">
                    ...
                    <a href="../../fr/rooms/jack-the-ripper.php">French</a>
                  ...
                  <div class="lang">
                    ...
                    <a href="../../es/rooms/jack-the-ripper.php">Spanish</a>
...
<?php include '../../inc/carousel-jack-the-ripper.php'; ?>

<!-- end of carousel -->



<section class="container-fluid room-jack text-center " id="mainsect">
  ...
  <div class="info-container" style="padding-top:50px;">
    ...
    <div id="rooms" class="mt-5" style="display: flex;align-items: center;justify-content:center;">
      ...
      <h1 style="display:inline-block;line-height:5rem;font-size:3rem;">JACK THE RIPPER</h1>

    </div>



    <p class="room-desc" style="">Zurück in den 1880er Jahren in London nehmen die Spieler an der Jagd des berüchtigten Serienmörders,<br>

       Jack the Ripper teil. Ein Raum mit schöner Szenographie und auch technologisch fortgeschritten.
...
<div class="right-icon"></div>
    ...
    <p class=" story" style="">London, 1888. Ein weiterer Mord geschah in dieser Nacht,<br>

       auch in Whitechappel. Der Ripper schlägt wieder und die Leute sind erschrocken,<br>

        fast niemand ist auf der Straße. Außer dir. Wenn die Hinweise, die Sie in Ihren Händen haben korrekt sind,<br>

         wird heute Abend alles enden. Oder Nein? Es liegt an Ihnen…</p>
