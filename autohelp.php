...
<head>
  ...
  <meta name="description" content="Autohelp Hint System, (AHS) is a extra feature which GAME OVER escape rooms developed and install into escape games.">
...
<body id="page-top">
  ...
  <section id="autohelp_main" class="container-fluid text-center">
    ...
    <div class="autohelp-box">
      <img src="img/menus_logo/autohelp.svg" alt="" style="width:55px;height:55px;">
      <h1>AUTOHELP <br> HINT SYSTEM</h1>

      <p>Autohelp Hint System is an automated way to control & guide the players in
        the room . The main idea of <span style="font-weight:700;">AHS</span> is that the players receive
        automatically
        the necessary hint from a themed touch screen attached to the scenography.
        The biggest benefit of the Autohelp Hint System is that the customer crucially reduces the personnel salary costs, as there is no necessity of having
        one Game Master operating each room.</p>
  ...
  <section class="container-fluid text-center features" style="">
    <div class="row">
      ...
      <div class="features-list">
        <ul>
          <li>One Game Master can operate 3-4 rooms at the same time</li>
          <li>Adjustable time frames between the given hints</li>
          <li>Available in English and Local Language </li>
          <li>Countdown timer on screen</li>
          <li>Themed Background for each room</li>
          <li>Operation - Maintenance Manuals available.</li>
          <li>Emergency button for further Help</li>
          <li>Spare Parts</li>
        </ul>
      </div>
    </div>
  ...
  <section class="container-fluid text-center red" style="">
    ...
    <div class="p-container" style="">
      <div class="left-p" style="">
        <p style="">When an escape game is in operation, the players have to solve a
          number of riddles and puzzles so step by step they must find the
          exit within an hour.</p>
        <p style="">
          During these 60 minutes there is an operator (Game Master)
          watching them through cameras so if they need a hint, he communicates with
          them by typing in a in-room monitor or talking to them directly
          through a microphone.
        </p>
      </div>
      <div class="right-p" style="">
        <p style="" >As a result of this requirement, escape game companies need to have enough
          personnel to operate all the rooms properly. Of course this is a high expense
          for the business owner but necessary to keep the quality of the service
          in high level.</p>
      </div>
