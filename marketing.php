...
<section id="marketing_main1" class="container-fluid text-center">
  <img style=" opacity: 0.7; " src="img/construction/bg.png" alt="">
    ...
    <p class="" style="line-height:20px;">
     Choosing to come under the GAME OVER Escape Rooms <br class="display-items">
      brand ID & marketing kits, you will be provided with extreme IT & dedicated Artwork support.
     <br><br>
     All your promotional needs will be covered by our professional design dpt.
     <br class="display-items">You will immediately gain access to our basic media kit. Printable or digital graphics
      will be available anytime depending on your campaign,
     according to our global marketing standards.
     <br><br>
     Also all your demands regarding web support will be covered by our web development dpt.
    </p>
  </div>
      </div>
...
<section id="technical-list" class="container-fluid " style="text-align:center;">
    ...
    <ul class="" style="">
      ...
      <li><p>Website SSL Certification</p><span></span></li>
      <li><p>Bilingual Website </p><span></span></li>
      <li><p>Booking System </p><span></span></li>
      <li><p>GAME OVER Cloud Access</p><span></span></li>
      <li><p>Email Accounts</p><span></span></li>
      <li><p>Website Update - Extension</p><span></span></li>
      <li><p>Extreme IT Support</p><span></span></li>
      <li><p>Basic Marketing Kit</p><span></span></li>
      <li><p>Printable Promo Material</p><span></span></li>
      <li><p>Dedicated Artwork Support</p><span></span></li>
      <li><p>Social Media Artwork</p><span></span></li>

      <li><p>Website Mobile Optimization</p><span></span></li>
