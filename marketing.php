  ...
  <section id="technical-list" class="container-fluid " style="text-align:center;">
    ...
    <div class='left-div'>
      <ul class="" style="">
        ...
        <li>
          <p>Website SSL Certification</p><span></span>
        </li>
        <li>
          <p>Bilingual Website </p><span></span>
        </li>
        <li>
          <p>Booking System </p><span></span>
        </li>
        <li>
          <p>GAME OVER Cloud Access</p><span></span>
        </li>
        <li>
          <p>Email Accounts</p><span></span>
        </li>
        <li>
          <p>Website Update - Extension</p><span></span>
        </li>
        <li>
          <p>Extreme IT Support</p><span></span>
        </li>
        <li>
          <p>Basic Marketing Kit</p><span></span>
        </li>
        <li>
          <p>Printable Promo Material</p><span></span>
        </li>
        <li>
          <p>Dedicated Artwork Support</p><span></span>
        </li>
        <li>
        ...
        <li>
          <p>Website Mobile Optimization</p><span></span>
        </li>
