...
#contact_form
  ...
  <section id="construction_main" class="container-fluid text-center">
    ...
    <div class="">
      ...
      <h1 class="" style="font-weight:550;text-align:right;"> <img class="team-img" src="../img/menus_logo/construction.svg" style="margin-right:15px;" alt="">CONSTRUCCION</h1>

      <p class="">

        Nuestras soluciones integrales incluyen accesorios y decoraciones de alta <br> calidad hechos a mano, acertijos electrónicos probados <br>

        durante mucho tiempo y mecatrónicos.<br> Todo esto combinado ofrece un resultado <br>único en nuestras salas. El equipo de GAME OVER garantiza que <br>

        continuaremos trabajando duro con el objetivo de innovar y aumentar la calidad de nuestros productos.
  ...
  <section id="technical-list" class="container-fluid " style="text-align:center;">
    ...
    <div class="img-container1" style=" ">
      ...
      <ul class="" style="">
        ...
        <li><p>Costos de transporte</p><span></span></li>

        <li><p>Boletos y alojamiento para nuestro personal</p><span></span></li>

        <li><p>Todo el mobiliario y la decoració</p><span></span></li>

        <li><p>Escenografía de la sala </p><span></span></li>

        <li><p> Luces, dispositivos y efectos especiales</p><span></span></li>

        <li><p>Accesorios de juego y eléctricos</p><span></span></li>

        <li><p>Construcciones especiales</p><span></span></li>

        <li><p>Trucos, acertijos, escenarios</p><span></span></li>

        <li><p>Piezas de repuesto</p><span></span></li>

        <li><p>Equipo para sala de control</p><span></span></li>

        <li><p>Cámaras, monitores, altavoces</p><span></span></li>

        <li><p>Escenas teatrales del juego</p><span></span></li>

        <li><p>Documentación completa del juego</p><span></span></li>

        <li><p>Formación para los gerentes y los supervisores de juego</p><span></span></li>

        <li><p>Soporte técnico en línea</p><span></span></li>

        <li><p>Garantía de reemplazo durante un (1) año de todos nuestros marcadores y accesorios</p><span></span></li>

        <li><p>Manuales e instrucciones</p><span></span></li>
