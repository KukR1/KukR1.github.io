...
<body id="page-top">
  ...
  <section id="technical-list" class="container-fluid " style="text-align:center;">
    ...
    <ul class="" style="">
      ...
      <li>
        <p>Costos de transporte</p><span></span>
      </li>

      <li>
        <p>Boletos y alojamiento para nuestro personal</p><span></span>
      </li>

      <li>
        <p>Todo el mobiliario y la decoració</p><span></span>
      </li>

      <li>
        <p>Escenografía de la sala </p><span></span>
      </li>

      <li>
        <p> Luces, dispositivos y efectos especiales</p><span></span>
      </li>

      <li>
        <p>Accesorios de juego y eléctricos</p><span></span>
      </li>

      <li>
        <p>Construcciones especiales</p><span></span>
      </li>

      <li>
        <p>Trucos, acertijos, escenarios</p><span></span>
      </li>

      <li>
        <p>Piezas de repuesto</p><span></span>
      </li>

      <li>
        <p>Equipo para sala de control</p><span></span>
      </li>

      <li>
        <p>Cámaras, monitores, altavoces</p><span></span>
      </li>

      <li>
        <p>Escenas teatrales del juego</p><span></span>
      </li>

      <li>
        <p>Documentación completa del juego</p><span></span>
      </li>

      <li>
        <p>Formación para los gerentes y los supervisores de juego</p><span></span>
      </li>

      <li>
        <p>Soporte técnico en línea</p><span></span>
      </li>

      <li>
        <p>Garantía de reemplazo durante un (1) año de todos nuestros marcadores y accesorios</p><span></span>
      </li>

      <li>
        <p>Manuales e instrucciones</p><span></span>
      </li>
