...
<head>
  ...
  <meta name="description" content="Space Wars | Un juego de escape dentro de una nave espacial realista.

     Características avanzadas tecnológicamente de forma extrema. Incluso parece un vídeo juego verdadero,

      llevado a la vida real junto<br> con impresionantes factores y efectos especiales">
  ...
  <meta property="og:url" content="https://www.escapegameover.com/es/rooms/space-wars.php" />
...
<section class="container-fluid room-space text-center " id="mainsect">
  ...
  <div class="info-container" style="">
    ...
    <p class="room-desc" style="">Un juego de escape dentro de una nave espacial realista.<br>

       Características avanzadas tecnológicamente de forma extrema.<br> Incluso parece un vídeo juego verdadero,
...
<div class="right-icon"></div>
    ...
    <p class=" story" style="">Han pasado dos años desde que el Lancer 19A desapareció y la guerra por el control de la galaxia se convirtió en una guerra para proteger al planeta de la invasión. Lancer 19A era el bastión de la flota espacial para la batalla sobre la Tierra cuando misteriosamente se perdió el rastro... hasta la semana pasada cuando el rastro reapareció. Lancer fue ubicado en el medio de un campo de asteroides y vosotros sois el equipo que EBSF envía dentro de la cápsula espacial para recuperar la nave espacial, investigar las razones de la desaparición y volar la nave con seguridad lejos de los asteroides y nuevamente a la Tierra.</p>
