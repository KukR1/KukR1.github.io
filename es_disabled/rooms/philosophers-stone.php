...
<body id="page-top">
  ...
  <section class="container-fluid philosopher text-center " id="mainsect">
    ...
    <div class="info-container" style="">
      ...
      <p class="room-desc" style="">Una aventura de juego de escape, inspirada por la famosa serie. Una combinación de juegos y de la tecnología más avanzada,<br>

        llena de factores sorpresa y efectos visuales, que lleva a la vida real una experiencia única.
      ...
      <p class=" story" style="">El Ser Oscuro se ha despertado. Solo el poder de la Piedra Filosofal, oculto en el interior de una cámara secreta llena de peligros mágicos y de potentes hechizos de magos y brujas, puede poner fin a su reinado de terror. Tú y tu equipo deberéis encontrar la Piedra y derrotar a la oscuridad naciente, o todo estará perdido. Daos prisa, ya que el tiempo no está de vuestro lado. </p>
