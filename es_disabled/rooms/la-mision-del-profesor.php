...
Avoid the security , and print as much money as you can.  ">
  ...
  <!-- <meta property="og:url" content="https://www.escapegameover.com/es/rooms/la-mision-del-profesor.php" /> -->
...
<section class="container-fluid room-jacknew text-center " id="mainsect">
  ...
  <div  id="rooms" class="mt-5" style="display: flex;align-items: center;justify-content:center;">
    ...
    <p class="room-desc" style="">Sé parte de la famosa tripulación para completar el robo del dinero, asaltando la Casa Nacional de la Moneda.<br>
Elude a la seguridad e imprime todo el dinero que puedas.
...
<div class="right-icon"></div>
    ...
    <p class=" story" style="">
    Ha llegado el momento del robo más grande de todos los tiempos. Así que colócate las máscaras y los uniformes, y demuestra lo que eres capaz.
El plan está completamente diseñado y el dinero te espera, pero cuando las puertas del banco se cierren,
tu equipo estará a prueba como nunca antes.
¿Podrán permanecer unidos bajo una presión sofocante y tomar decisiones difíciles o se dividirán y enfrentarán?
El plan del profesor ya se ha puesto en práctica y el mayor peligro eres tú.
