...
<div class="container-fluid nav-container p-0 fixed-top" style="">
  ...
  <?php include '../../inc/es-menu-tabs.php'; ?>
...
<section class="container-fluid room-pirates text-center " id="mainsect">
  ...
  <div class="text-center" style="padding-top:50px;">
    ...
    <p class="room-desc" style="">Representación del famoso barco «Venganza de la Reina Ana» del poderoso Barbanegra.<br>
     La tecnología, incorporada en los grandes diseños y accesorios, da vida al barco.
...
<div class="right-icon"></div>
    ...
    <p class=" story" style="">Cuando planeaste la operación en la taberna, todo parecía lógico y posible... Ahora, parado en Bahía Tortuga a medianoche y mirando el barco con el alma llena de temor, nada parece tan lógico. Estás tan cerca del objeto más valioso en el mundo de los piratas... Sin embargo, nadie subió al «Venganza de la Reina Ana» y regresó para contar la historia. Sabes que al amanecer Barbanegra y su tripulación volverán al barco, así que ahora es tu única oportunidad... ¡Adelante!
