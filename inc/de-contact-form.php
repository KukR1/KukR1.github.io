	...
	<p class="p animated infinite pulse" style="height:40px;line-height:40px;cursor:pointer;"><span style="position:relative;left:8px;"></span></p>
		...
		<div id="contact" class="" >
			...
			<div class="col-12 text-center">
				...
				<img src="../img/menus_logo/contact.svg" alt="Kontaktiere uns" style="width:50px;margin-bottom:2%;" alt="">

				<h1><span style="font-size:2.5rem;font-weight:550;">KONTAKTIERE UNS</span></h1>
      ...
      <div id="form" class="container2">
       ...
       <form  method="post" action="../base.php" role="form" onsubmit="return validateForm()">
        ...
        <li>
            ...
            <input tabindex="1" type="text" id="name"  name="name" tabindex="-1" autocomplete="off" required >
          ...
          <li>
            ...
            <input tabindex="3" type="email" id="email"  name="email"tabindex="-1" autocomplete="off" required >
        ...
        <select tabindex="4" id="country" name="country" class="form-control" style="color:gray;">
            ...
            <option value="default">Wählen Sie ihr Land aus</option>
          ...
          <li>
            ...
            <input tabindex="6" id="submit"name="submit" style="width:100%; padding: 8px 16px;border: none;background: transparent;color: #f2f2f2;text-transform: none;font-size: 15px;border-radius: 2px;cursor: pointer;" type="submit" value="Send >" onclick="validateForm();">
    ...
    <div class="ul-container" style="display:flex;width: 100%;">
       ...
       <div class="footer-flex" style="">
          ...
          <div class="footer-logo">
             ...
             <a class="js-scroll-trigger" href="https://www.escapegameover.com/de/index.php">
