<div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel">
    <div class="carousel-inner" role="listbox">
        <div class="carousel-item active">
            <picture>
                <img class='w-100' src="/img/room_slider_images/game_over_illuminati.jpg" alt="Illuminati">
            </picture>
        </div>
        ...
        <div class="carousel-item">
            <img class='w-100' src="/img/room_slider_images/game_over_illuminati4.jpg" alt="Jack The Ripper">
        </div>
        <div class="carousel-item">
            <img class='w-100' src="/img/room_slider_images/game_over_illuminati5.jpg" alt="Jack The Ripper">
        </div>
