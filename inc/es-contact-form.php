	...
	<p class="p animated infinite pulse" style="height:40px;line-height:40px;cursor:pointer;"><span style="position:relative;left:8px;"></span></p>
		...
		<div id="contact" class="" >
			...
			<div class="col-12 text-center">
				...
				<img src="../img/menus_logo/contact.svg" alt="Contáctenos" style="width:50px;margin-bottom:2%;" alt="">

				<h1><span style="font-size:2.5rem;font-weight:550;">CONTÁCTENOS</span></h1>
    ...
    <div class="ul-container" style="display:flex;width: 100%;">
       ...
       <div class="footer-flex" style="">
          ...
          <div class="footer-logo">
             ...
             <a class="js-scroll-trigger" href="https://www.escapegameover.com/es/index.php">
