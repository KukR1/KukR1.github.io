...
<head>
  ...
  <meta name="description" content="Chocolate Factory | Un mystère pour les adultes et les enfants.

    Faufilez-vous dans une usine de chocolat, utilisez tous vos sens,

     allumez les machines pour gagner le temps et demandez la recette précieuse.">
  ...
  <meta property="og:url" content="https://www.escapegameover.com/fr/rooms/chocolate-factory.php" />
...
<body id="page-top">
  ...
  <section class="container-fluid room-choco text-center " id="mainsect">
    ...
    <div class="info-container" style="padding-top:50px;">
      ...
      <p class="room-desc" style="">Un mystère pour les adultes et les enfants. <br>

        Faufilez-vous dans une usine de chocolat, utilisez tous vos sens,<br>
      ...
      <p class=" story" style="">Pendant de nombreuses années, il a été gardé comme un grand secret. Les rumeurs ont dit qu’il ya une machine spéciale faite à la main qui donne ce goût magique à leurs chocolats. Tous ces derniers jusqu’à ce soir, vous et votre équipe, vous êtes dévoués à vous faufiler par le biais de la salle restreinte dans la plus grande usine de chocolat de Suisse! Votre but est de trouver comment la machine fonctionne, la mettre en fonctionnement et voler la recette secrète du meilleur chocolat qui a été jamais fait par l’homme.</p>
