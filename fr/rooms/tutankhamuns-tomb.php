            ...
            <div class="" style="display: flex;justify-content: center;align-items: center;padding-bottom:40px;font-size:13px;">
              ...
              <div class="lang">
                  ...
                  <div class="lang">
                    ...
                    <a href="../../gr/rooms/tutankhamuns-tomb.php">Greek</a>
...
<section class="container-fluid room-tut text-center " id="mainsect">
  ...
  <div class="info-container" style="">
    ...
    Cette Room est une vive représentation de l'intérieur d'une ancienne pyramide égyptienne.<br> Une salle très avancée tant au niveau du scenario que des procédés technologiques.
...
<div class="right-icon"></div>
    ...
    <p class=" story" style="">
    Vous avez atteint le hall d’entrée, Si vous ouvrez cette porte, Vous pourrez découvrir le secret du grand Pharaon.<br>

Faites attention ! Si vous dépassez l’heure, Vous serez maudits à jamais.
  ...
  <div class="" style="padding-bottom: 30px; margin-bottom:10px;">
