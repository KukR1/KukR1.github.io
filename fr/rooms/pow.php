...
<head>
  ...
  <meta name="description" content="Prisoners of War | Une salle à thème militaire. D’abord, les joueurs doivent s’échapper

     d’une cellule de prison, puis d’une base militaire entière, en résolvant tous les 15 étapes.">
  ...
  <meta property="og:url" content="https://www.escapegameover.com/fr/rooms/pow.php" />
...
<section class="container-fluid room-pow text-center " id="mainsect">
  ...
  <div class="info-container" style="padding-top:50px;">
    ...
    <p class="room-desc" style="">Une salle à thème militaire. D’abord, les joueurs doivent s’échapper <br>
...
<div class="right-icon"></div>
    ...
    <p class=" story" style="">Vous vous trouvez dans une opération militaire en Corée du Nord derrière les lignes ennemies. Quelque chose s’est très mal passé et votre groupe a perdu le contact avec l’unité et a été capturé par les forces ennemies. Maintenant vous êtes un prisonnier de guerre! Utilisez vos SERE (Survie, évasion, résistance et échappement) compétences afin de trouver un chemin de retour dans la jungle et de retour à l’action.
