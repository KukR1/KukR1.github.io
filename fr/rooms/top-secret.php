...
<head>
  ...
  <meta name="description" content="Top Secret | Un jeu d'évasion sur le thème de l’espionnage,

    dans lequel les joueurs doivent s'évader d'une prison et voler des dossiers

    top-secret en s'introduisant dans une chambre-forte ultra sécurisée.">
  ...
  <meta property="og:url" content="https://www.escapegameover.com/fr/rooms/top-secret.php" />
...
<body id="page-top">
  ...
  <section class="container-fluid room-top text-center " id="mainsect">
    ...
    <div class="info-container" style="">
      ...
      <p class="room-desc" style="">Un jeu d'évasion sur le thème de l’espionnage, <br>

        dans lequel les joueurs doivent s'évader d'une prison et voler des dossiers <br>
      ...
      <p class=" story" style="">Le seule manière de pénétrer dans

        ce Quartier général paramilitaire était de se laisser capturer par les gardes. Vous y voilà! Vous devez maintenant vous échapper

        de la prison et vous introduire dans la chambre-forte ultra sécurisée pour dérober les plans détaillés de leur missile XJ7 ainsi

        que tous leurs dossiers top-secret. Dépêchez-vous!
