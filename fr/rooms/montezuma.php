...
<head>
  ...
  <meta name="description" content="Forbidden Temple of Montezuma | La salle est une véritable représentation d’un ancien temple aztèque dans la jungle.

     C’est un jeu tentant, il y a beaucoup de technologie derrière les scènes

      ainsi que la haute qualité de scénographie thématique rendent cette salle unique.">
  ...
  <meta property="og:url" content="https://www.escapegameover.com/fr/rooms/montezuma.php" />
...
<body id="page-top">
  ...
  <section class="container-fluid room-monte text-center " id="mainsect">
    ...
    <div class="info-container" style="padding-top:50px;">
      ...
      <p class="room-desc" style=""> La salle est une véritable représentation d’un ancien temple aztèque dans la jungle.<br>

        C’est un jeu tentant, il y a beaucoup de technologie derrière les scènes <br>
      ...
      <p class=" story" style="">Ça fait beaucoup d’années que votre professeur de la faculté

        archéologique a disparu. Vous vous êtes engagés les uns envers les autres à mettre à jour ses recherches sur les aztèques! Donc maintenant, vous êtes là, en suivant

        ses pistes bien chiffrées … Mais méfiez-vous…Ce qui a provoqué sa perte ça dépend de vous peut-être.
