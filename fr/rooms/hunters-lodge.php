...
<head>
  ...
  <meta name="description" content="Hunter's Lodge | La reconstitution fidèle d'un pavillon de chasse et un scénario
    fascinant pour s’en échapper. Une atmosphère prenante et un déroulement consistant
     en des énigmes et jeux thématiques.">
  ...
  <meta property="og:url" content="https://www.escapegameover.com/fr/rooms/hunters-lodge.php" />
  ...
  <meta name="twitter:title" content=" Hunter's Lodge | GAME OVER Escape Rooms " />
...
<section class="container-fluid room-lodge text-center " id="mainsect">
  ...
  <div class="info-container" style="padding-top:50px;">
    ...
    <p class="room-desc" style="">La reconstitution fidèle d'un pavillon de chasse et un scénario <br>
      fascinant pour s’en échapper. Une atmosphère prenante et un déroulement consistant <br>
       en des énigmes et jeux thématiques.
    </p>
...
<div class="right-icon"></div>
    ...
    <p class=" story" style="">Votre aventure dans les bois a mal tourné à cause du blizzard qui s’est soudain mis à souffler. Heureusement, une lumière est apparue à l’horizon et, après quelques minutes de marche dans la neige, vous avez trouvé une cabane dans les bois. Apparemment, un chasseur y vit mais vous comprenez rapidement qu'il ne s'agit pas là du pavillon du chasseur, mais peut-être du piège du chasseur. Serez-vous ou non sa proie? Il vous reste 60 minutes pour le découvrir!</p>
  </div>
