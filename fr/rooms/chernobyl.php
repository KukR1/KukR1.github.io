...
<head>
  ...
  <meta name="description" content="Chernobyl | Une aventure qui se déroule dans un vieux réacteur abandonné,
    elle cache beaucoup de secrets, de puzzles et de technologie, pour laisser les joueurs s’échapper.">
  ...
  <meta property="og:url" content="https://www.escapegameover.com/fr/rooms/chernobyl.php" />
...
<section class="container-fluid room-reactor text-center " id="mainsect">
  ...
  <div class="info-container" style="">
    ...
    <p class="room-desc" style="">Une aventure qui se déroule dans un vieux réacteur abandonné, <br>
      elle cache beaucoup de secrets, de puzzles et de technologie, pour laisser les joueurs s’échapper.
    </p>
...
<div class="right-icon"></div>
    ...
    <p class=" story" style="">Cette année, tes copains et toi, vous décidez de partir en voyage d’agrément annuel, dans une cabane, profondément dans la forêt de Cracovie. La première journée était un peu ennuyeuse, mais quand un parmi vous découvre un réacteur abandonné dans le bois… Ce soir vous êtes prêts à vivre l’expérience la plus passionnante de votre vie …Ainsi, vous entrez dans l’usine qui n’est pas si mort qu’il n’y paraît. Votre aventure devient une course pour échapper à cet endroit effrayant ASAP! Faites attention! L’oxygène semble être disponible pour une heure encore…Donc… Dépêchez-vous!</p>
  </div>
