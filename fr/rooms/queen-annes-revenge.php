...
<head>
 ...
 <meta name="viewport" content="width=device-width, initial-scale=1.0, shrink-to-fit=no">
  ...
  <title>Pirates - Queen Anne's Revenge| GAME OVER Escape Rooms</title>

  <meta name="keywords" content="" />

  <meta name="description" content=" Pirates Of Caribbean | Representation of the notorious Queen Anne’s Revenge, ship of the mighty Blackbeard. <br>

Technology, embedded into great set designs and props makes the ship “alive”. ">
  ...
  <meta property="og:title" content="Pirates - Queen Anne's Revenge | GAME OVER Escape Rooms" />

  <meta property="og:url" content="https://www.escapegameover.com/queen-annes-revenge.php" />
  ...
  <link rel="stylesheet" href="../../rooms/boot-custom.css">
...
.room-pirates {
  ...
  .room-pirates::after {
    ...
    background:url("../../img/room_slider_images/pirates_extended/05.jpg") no-repeat center center ;
         ...
         <button class="closebtn" >&times;</button>
            ...
            <div class="" style="display: flex;justify-content: center;align-items: center;padding-bottom:40px;font-size:13px;">
              ...
              <div class="lang">
                    ...
                    <a href="../../rooms/queen-annes-revenge.php">English</a>
                  ...
                  <div class="lang">
                    ...
                    <a style="align-items:center;" href="../../it/rooms/queen-annes-revenge.php">Italian</a>
                  ...
                  <div class="lang">
                    ...
                    <a href="../../de/rooms/queen-annes-revenge.php">German</a>
                  ...
                  <div class="lang">
                    ...
                    <a href="../../fr/rooms/queen-annes-revenge.php">French</a>
                  ...
                  <div class="lang">
                    ...
                    <a href="../../es/rooms/queen-annes-revenge.php">Spanish</a>
...
<?php include '../../inc/carousel-queen-annes-revenge.php'; ?>

<!-- end of carousel -->



<section class="container-fluid room-pirates text-center " id="mainsect">
  ...
  <div class="text-center" style="padding-top:50px;">
    ...
    <div  style="display: flex;align-items: center;justify-content:center;line-height:5rem;">

      <img src="../../img/svg/pirates.svg" classs="img-fluid" alt="" style="width: 5rem;height:5rem;">

      <h1 style="display:inline-block;line-height:1rem;text-align:left;margin-left:10px;">PIRATES<br><span style=" font-size:16px;font-weight:300">QUEEN ANNE'S REVENGE</span></h1>

    </div>

    <p class="room-desc" style="">Cette Room est une représentation du Queen Anne’s Revenge, le fabuleux bateau de Barbe Noire.<br> La technologie de cette salle, intégrée dans de superbes décors et accessoires, rend le navire "vivant".
...
<div class="right-icon"></div>
    ...
    <p class=" story" style="">Lorsque vous avez planifié votre opération à la Taverne, tout semblait logique et faisable ... Maintenant, debout face à la baie de Tortuga à minuit et la regardant avec vos âmes, pleine d'effroi, rien ne semble si logique. Vous êtes si près de l'objet le plus précieux du monde des pirates, mais personne n'est monté dans la vengeance de la reine Anne et n'est revenu pour raconter l'histoire. Vous savez que l'aube amènera Barbe Noire et son équipage au navire, donc votre seule chance est maintenant ... Continuez !
...
<?php include '../../inc/footer.php';?>
 ...
 <script>             var divs1 = document.querySelectorAll("img.dropbtn,.burger-container,.logo-container,.card1,footer,#carouselExampleIndicators,#mainsect,#click");             var divsblur = document.querySelectorAll(".nav-container,footer,#carouselExampleIndicators,#mainsect");   </script><script src="../../js/js_all.js"></script>
