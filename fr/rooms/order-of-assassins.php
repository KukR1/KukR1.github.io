...
<section id="mainsect"  class="container-fluid room-order text-center">
  ...
  <div class="info-container" style="padding-top:50px;">
    ...
    Cette Room est une représentation de la tombe d’un Templier construite au Moyen Âge.<br> Les effets à couper le souffle et les facteurs Wow, l’atmosphère immersive combinée à la scénographie de qualité supérieure,<br> fournissent à cet Escape Room un résultat unique.
      </p>
...
<div class="right-icon"></div>
    ...
    <p class=" story" style="">
    1291 avant notre ère. Après la chute d'Acre, les Templiers sont revenus en Europe, apportant avec eux leur héritage et le plus grand trésor de l'humanité, la Pomme d'Eden..

Aujourd'hui. L'ancienne feuille de papyrus que vous tenez n'a écrit que quelques mots:

"Cette.. pièce d'argent a chassé Adam et Eve. Elle a transformé des bâtons en serpents. Séparée et fermée la mer Rouge. Pariss l'a utilisé pour lancer la guerre de Troie. Avec elle, un pauvre charpentier transforma l'eau en vin. Puisse le dernier d'entre nous être son gardien éternel "

Vous êtes à Malte, devant la tombe du Dernier Magistrat Templier qui est parti vivant d'Acre ...
</p>
  </div>
