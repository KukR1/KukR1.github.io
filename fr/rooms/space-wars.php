...
<section class="container-fluid room-space text-center " id="mainsect">
  ...
  <div class="info-container" style="">
    ...
    Une Escape Room à l'intérieur d'un vaisseau spatial réaliste.<br> Une immersion complète grâce à des fonctions technologiques, des effets spéciaux et des facteurs wow à couper le souffle.
...
<div class="right-icon"></div>
    ...
    <p class=" story" style="">
    Vous êtes transporté à bord d’un vaisseau spatial qui avait disparu au milieu d’un champ d’astéroïdes.<br> Pourquoi a-t-il disparu? Nous n’en savons rien... Prenez le contrôle du vaisseau, activez les armes et ramenez le sur Terre.
    </p>
