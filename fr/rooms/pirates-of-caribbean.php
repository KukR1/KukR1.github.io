  ...
  <section class="container-fluid room-pirates text-center " id="mainsect">
    ...
    <div class="info-container" style="">
      ...
      <p class="room-desc" style="">
        ...
        Dans cette Room, les joueurs s’immergent dans la cabine de Pearl, le navire d'un puissant pirate,<br> pour rechercher la carte avec les localisations des célèbres "5 trésors des Caraïbes"
      </p>
      ...
      <p class=" story" style="">
        ...
        Vous êtes dans la cabine du pirate le plus cruel de tous les temps, Edward Thatch, connu sous le nom de "Barbe Noire".<br> Vous êtes si proche de l'objet le plus précieux pour chaque pirate, mais le lever du soleil ramènera Barbe Noire et son équipage au bateau! Arriverez vous à le récupérer avant son retour ?
