...
<head>
  ...
  <meta name="description" content=" Minotaur's Labyrinth | Félicitations à vous! Vous avez sauvé votre vie en tuant le féroce Minotaure, mais ce n’était pas le défi le plus difficile. Maintenant vous n’avez qu’une heure pour trouver votre sortie du labyrinthe avant que le roi Minos vienne avec ses soldats.">
  ...
  <meta property="og:url" content="https://www.escapegameover.com/fr/rooms/mino.php" />
...
<body id="page-top">
  ...
  <?php include '../../inc/carousel-mino.php'; ?>
  ...
  <section class="container-fluid room-mino text-center " id="mainsect">
    ...
    <div class="info-container" style="padding-top:50px;">
      ...
      <p class="room-desc" style="">Cette salle est une représentation du labyrinthe du roi Minos en Crète antique.<br>

        Un sujet très populaire dans la mythologie grecque, le jeu est un grand défi puisqu’il est consisté de 19 étapes.
      ...
      <p class=" story" style=""> Félicitations à vous! Vous avez sauvé votre vie en tuant le féroce Minotaure, mais ce n’était pas le défi le plus difficile. Maintenant vous n’avez qu’une heure pour trouver votre sortie du labyrinthe avant que le roi Minos vienne avec ses soldats.
