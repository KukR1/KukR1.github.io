...
<head>
  ...
  <meta name="description" content="Phantazma - Medieval castle | Cette salle peut être fournie en deux modes différents.

     Le mode de CHÂTEAU MÉDIÉVAL, Il s’agit de l’histoire médiévale dans un château mystérieux.

      Le mode PHANTAZMA, C’est une tour sombre, effrayante, abandonnée avec de nombreuses

       rumeurs étranges à son sujet. Il peut également accueillir un rôle d’acteur en direct. ">
  ...
  <meta property="og:url" content="https://www.escapegameover.com/fr/rooms/phantazma.php" />
  ...
  <style media="screen">
    ...
    .room-phantazma::after {
      ...
      background: url("../../img/room_slider_images/phantazma (5).jpg") no-repeat center center;
...
<body id="page-top">
  ...
  <section class="container-fluid room-phantazma text-center " id="mainsect">
    ...
    <div class="info-container" style="padding-top:50px;">
      ...
      <p class="room-desc" style="">Cette salle peut être fournie en deux modes différents.<br>

        Le mode de CHÂTEAU MÉDIÉVAL, Il s’agit de l’histoire médiévale dans un château mystérieux.<br>

        Le mode PHANTAZMA, C’est une tour sombre, effrayante, abandonnée avec de nombreuses <br>
      ...
      <p class=" story" style=""> Des rumeurs et des légendes vous ont menés là! Les calendriers de ceux qui ont essayé avant vous d’arrêter ici, rappelez-vous? De la citadelle Salah ed Din’s, ils se sont déplacés dans le désert, à un poste de garde, où la légende dit que le dernier fondateur de l’ordre des chevaliers templiers a disparu! Personne n’est revenu pour confirmer les histoires…Quand il fait clair de lune les caravanes du désert voient des lumières d’un mille de distance et ils ont appelé la tour hantée, mais les vieilles gens croient encore que le croisé était un démon et qu’il est encore VIVANT!</p>
