...
<section class="container-fluid room-jacknew text-center " id="mainsect">
  ...
  <div  id="rooms" class="mt-5" style="display: flex;align-items: center;justify-content:center;">
    ...
    Faites partie de la célèbre équipe pour terminer le braquage de la Monnaie Nationale.<br> Évitez de vous faire voir par la sécurité tout en imprimant le plus d’argent possible !
...
<div class="right-icon"></div>
    ...
    <p class=" story" style="">
    Le temps du plus grand braquage de tous les temps est arrivé, alors mettez vos masques et vos uniformes, et montrez de quoi vous êtes capables. Le plan est parfait et l’argent vous attend, mais une fois les portes fermées, votre équipe sera testée comme jamais auparavant. Saurez-vous rester unis malgré la pression étouffante et face à des choix difficiles, ou allez-vous vous diviser et vous retourner les uns contre les autres ? Le plan du Professeur est déjà lancé, et vous êtes votre plus grand danger.
