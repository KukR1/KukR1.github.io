...
<body id="page-top">
  ...
  <section class="container-fluid arkham text-center " id="mainsect">
    ...
    <div class="info-container" style="">
      ...
      <p class="room-desc" style="">S'inspirant des plus grandes BD d'investigation de notre temps,<br> la prison d'Arkham oppose les joueurs aux génies du mal qui dirigent la ville.
      ...
      <p class=" story" style="">
        Lors des émeutes de la prison d’Arkham, un des plus dangereux gros méchant a réussi à s’échapper de sa cellule.<br> Son plan, s’il est concrétisé, aura des conséquences dévastatrices sur la totalité de la ville.<br> Vous et votre équipe êtes notre dernier espoir : infiltrez la prison,<br> récoltez des indices laissés derrière et mettez fin à cette folie avant qu’il ne soit trop tard.
