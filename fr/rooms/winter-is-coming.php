...
<head>
  ...
  <meta name="description" content="Winter Is Coming | L’histoire se déroule dans le fameux Castle Black of Game of Thrones
     de la série télévisée et ta mission consiste à sauver le monde pars le mort.
      Une salle très avancée sténographiquement et technologiquement.">
  ...
  <meta property="og:url" content="https://www.escapegameover.com/fr/rooms/winter-is-coming.php" />
...
<section class="container-fluid room-winter text-center " id="mainsect">
  ...
  <div class="info-container" style="">
    <div id="rooms" class="" style="display: flex;align-items: center;justify-content:center;padding-top:50px;">
      <img src="../../img/svg/got.svg" alt="" classs="img-fluid" alt="" style="width: 5rem;height:5rem;">
      <h1 style="display:inline-block;line-height:5rem;font-size:3rem;">WINTER IS COMING</h1>
    </div>

    <p class="room-desc" style=""> L’histoire se déroule dans le fameux Castle Black of Game of Thrones <br>

       de la série télévisée et ta mission consiste à sauver le monde pars le mort.<br>
        Une salle très avancée sténographiquement et technologiquement.
...
<div class="right-icon"></div>
    ...
    <p class=" story" style="">White Walkers ont traversé le mur et ils sont partout! Le monde a un nouvel ennemi et qu’est-ce qu’il est le pire? Il paraît invincible! Le seul espoir resté est un vieux manuscrit de Grand Meister selon lequel l’arme contre l’hiver est cachée dans la paroi de glace! Des représentants de toutes les grandes maisons se sont trouvés dans la salle du Castle Black, mais personne n’a trouvé quelque chose. Mais la salle dissimule peut-être plus qu’elle ne semble?</p>

      <div class="" style="padding-bottom: 30px;">
        <p>* Le trône de fer fait partie de la version étendue</p>
      </div>
  </div>
