...
<head>
  ...
  -->
   ...
   <meta name="description" content="Notre marque GAME OVER conçoit et produit des jeux d’évasion uniques">
...
<body id="page-top">
   ...
   <!-- <section>
      ...
      <img src="../img/cover_com.jpg" class="coverImage">
      <img src="../img/cover_mob.jpg" class="coverImagemob">
  </section> -->
   ...
   <section id="main1" class="background-section" style="">
      ...
      <!-- <div class="wedesign-box">
    <div class="wedesign-inner-box" >
		<img class="animated anim anim2" src="../img/home_page/wedesign.png" alt="" style="width:650px;">
			<p style="">design. construct. get locked. escape.</p>

<a class="js-scroll-trigger" href="#sect1">
            <div class="text-center arrow-button" style="">
                    <p>&lt;</p>
            </div>
            </a>
    </div>
   ...
   <section id="sect1" class=" container-fluid text-center">
      <div class="second-box">
         <img src="../img/menus_logo/aboutus.svg" alt="VIENS AVEC NOUS" style="width:45px;height:45px;">
         <h2>VIENS AVEC NOUS</h2>
         <div class="paragraph-container">
            <p class="fade1 fadeIn animated">Des salles d’échappement GAME OVER, <br>
               notre marque GAME OVER conçoit et produit des jeux d’évasion uniques</p>
            <p class="fade2 fadeIn animated inv">Des salles d’échappement GAME OVER, notre marque GAME OVER conçoit et produit des jeux d’évasion uniques, d’une qualité supérieure et d’une thématique très variée, qui peuvent être offerts à l’acheteur potentiel , soit en utilisant notre marque GAME OVER ainsi que les perspectives accompagnant une coopération permanente , soit en créant seulement des salles dessinées par GAME OVER , en utilisant la marque des acheteurs .



               Comme résultat d’une recherche continue qui vise à l’innovation dans notre domaine et le plan spécial de marketing qui définit notre marque GAME OVER, nous vous invitons de nous suivre à une carrière ambitieuse et profitable.



               On cherche des collaborateurs venant du monde entier, afin de développer notre réseau électronique et l’expérience du jeu d’échappement.</p>
   ...
   <section id="sect2" class="container-fluid text-center">
      <div class="second-box">
         <img src="../img/menus_logo/search.svg" alt="À PROPOS DES SALLES D'ÉVACUATION" style="width:45px;height:45px;">
         <h2>À PROPOS DES SALLES D'ÉVACUATION</h2>
         <div class="paragraph-container">
            <p class="fade1 fadeIn animated">Les salles d’échappements sont interactives</p>
            <p class="fade2 fadeIn animated inv">Les salles d’échappements sont interactives,les jeux sont vraiment fascinants à tel point qui
               peuvent mettre quelqu’un dans un rôle selon le scenario. Le but de ce jeu est à résoudre un certain nombre de devinettes, à trouver des objets et des indices cachés pour que les participants puissent résoudre le mystère et qu’ils échappent de la chambre à l’heure.



               Les jeux d’échappement sont devenus une tendance mondiale d’amusement au cours des dernières années, les amateurs des jeux ont intégré ces jeux dans leur activité quotidienne de divertissement, appelés joueurs d’échappement.</p>
         </div>
         <div class="text-center" style="margin:10px 0;">
   ...
   <section class="  container-fluid text-center" id="scenarios">
      <img src="../img/menus_logo/scenarios.svg" alt="SCÉNARIOS" style="width:45px;height:45px;">
      <h2>SCÉNARIOS</h2>
               ...
               <section id="senaria" class="content-section container-fluid" style="margin:0 auto;">
                  ...
                  <div class="row">
                     <div class="col-12 col-md-6">
                        ...
                        <a href="rooms/one-thousand-one-nights.php" title="">
                     ...
                     <div class="col-12 col-md-6">
                        ...
                        <a href="rooms/white-house.php" title="">
                           <div class="image-info-container" style=" flex-direction:column;align-items:center;">
                              <div style="display: flex; flex-direction:column; align-items:center">
                                 <div style="display:flex;margin-top:20px;flex-wrap: wrap;justify-content:center;">
                     ...
                     <div class="col-12 col-md-6">
                        ...
                        <a href="rooms/dracula.php" title="">
                           <div class="image-info-container" style=" flex-direction:column;align-items:center;">
                              <div style="display: flex; flex-direction:column; align-items:center">
                                 <div style="display:flex;margin-top:20px;flex-wrap: wrap;justify-content:center;">
                     ...
                     <div class="col-12 col-md-6">
                        <div class="image-box" title="">
                           <img class="img-fluid" src="/img/gallery_com/alice-in-wonderland.jpg" alt="Alice in Wonderland, Mushrooms!">
                        </div>
                        <a href="rooms/alice-in-wonderland.php" title="">
                           <div class="image-info-container" style=" flex-direction:column;align-items:center;">
                              <div style="display: flex; flex-direction:column; align-items:center">
                                 <div style="display:flex;margin-top:20px;flex-wrap: wrap;justify-content:center;">
                                    <img style="" src="/img/svg/alice-in-wonderland.svg" alt="">
                     ...
                     <div class="col-12  col-md-3 ">
                        <div class="image-box" title="">
                           <picture>
                              ...
                              <source type="image/webp" srcset="../img/mobile_thumbs/got.webp" media="(max-width: 767px)">
                              <source type="image/jpeg" srcset="../img/mobile_thumbs/got.jpg" media="(max-width: 767px)">
   ...
   <!-- About Us  -->
   <section id="whatwedo" data-src="../img/home_page/come_with_us.jpg" class="lazy container-fluid text-center">
      ...
      <div class="" style="display:flex;width:100%;align-items:center;justify-content:center;">
         <div class="third-box">
            ...
            <h2>CE QUE NOUS O<span style="margin-left:2px;">F</span>FRONS</h2>

            <p style="margin: 0 0 1.1rem;letter-spacing: 0.9px;">complete construction & marketing benefits</p>
      ...
      <div class="container-fluid whatwedo-container" style="">
         <div class=" text-center offer-box">
            ...
            <p>Nous concevons et nous créons des jeux d’échappement thématiques de qualité supérieure.</p>
         </div>
         <div class=" text-center offer-box">
            <a href="gallery.php">
               <div class="">
            ...
            <p>Nous pouvons être disponibles dans tous les pays du monde.</p>
         </div>
         <div class=" text-center offer-box">
            ...
            <p>Nous formons vos employés à l'utilisation des jeux, nous vous fournissons des manuels de jeu et de maintenance.</p>
         </div>
         <div class=" text-center offer-box">
            <div class="">
         ...
         <div class=" text-center offer-box">
            ...
            <p>Autohelp Hint System est un moyen automatisé de contrôler et de guider les joueurs dans la salle sans qu'un seul Game Master ne fonctionne dans chaque pièce.</p>
         </div>
         <div class=" text-center offer-box">
            <div class="">

            </div>
            <p>Vous pouvez utiliser votre propre logo ainsi que votre nom commercial ou utilisez Kits d’identification et de marketing.</p>
         </div>
         <div class=" text-center offer-box">
            <div class="">

            </div>
            <p>En rejoignant nos services de marketing, vous bénéficiez d'une assistance informatique et d'un support artistique extrême.</p>
         </div>
      </div>
   ...
   <footer class="" style="margin-bottom:40px;">
         ...
         <div class="ul-container" style="display:flex;    width: 100%;">
            <div class="footer-flex" style="">
               ...
               <ul class="company1" style="text-align:right;">
                  <li class="site-li-header">VIENS AVEC NOUS</li>
            ...
            <div class="footer-flex2" id="foot-dest">
               <ul class="contact1" style="text-align:left;">
                  <li class="site-li-header">CONTACTEZ NOUS</li>
         ...
         <div class="text-center footer3">
            <div class="links-container">
               <a href="https://www.facebook.com/gameoverescaperooms/">
                  <img src="../img/svg_social_icons/facebook.svg" alt="">
               </a>
               <a href="https://twitter.com/GameOverEscRoom">
                  <img src="../img/svg_social_icons/twitter.svg" alt="">
               </a>
               <a href="https://www.instagram.com/escape_game_over/">
                  <img src="../img/svg_social_icons/instagram.svg" alt="">
               </a>

               <a href="https://www.youtube.com/channel/UC1U-qoOY1FYBJQu046e3L0g">
                  <img src="../img/svg_social_icons/youtube.svg" alt="">
               </a>
               <a href="https://www.pinterest.com/iordanispapadop/game-over-escape-rooms/">
                  <img src="../img/svg_social_icons/pinterest.svg" alt="">
               </a>
            </div>
      ...
      <script>
         ...
         function openNav() {
            ...
            var divs1 = document.querySelectorAll("img.dropbtn,.burger-container,.logo-container,.card1,#sect1 ,#main1 ,#sect2 ,#scenarios ,#map-section ,#whatwedo ,footer,#contact_form");
         ...
         $(document).ready(function() {
            ...
            $('#contact_form p, #get_quote p,#contact_click').on('click', function() {
               ...
               if ($(".con-fix").hasClass("enabled")) {
                  ...
                  var divsblur = document.querySelectorAll(".nav-container,#sect1 ,#main1 ,#sect2 ,#scenarios ,#map-section ,#whatwedo ,footer");
