...
<head>
  ...
  <meta name="description" content="Chocolate Factory | >A mystery for adults and kids. Sneak into a chocolate factory, use all your senses, turn on the machinery to win the time and claim the precious recipe. ">
...
<body id="page-top">
  ...
  <?php include '../inc/en-carousel-chocolate-factory.php'; ?>
  ...
  <section class="container-fluid room-choco text-center " id="mainsect">
    ...
    <div class="info-container" style="padding-top:50px;">
      ...
      <p class="room-desc" style="">A mystery for adults and kids. Sneak into a chocolate factory,<br> use all your senses, turn on the machinery to win the time and claim the precious recipe.
