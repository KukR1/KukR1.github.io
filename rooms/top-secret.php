...
<head>
  ...
  <title>Top Secret | GAME OVER Escape Rooms</title>

  <meta name="keywords" content="" />

  <meta name="description" content="Top Secret | An espionage escape game, in which the players have to escape a prison and steal Top Secret Files by breaking into the high security Vault. ">
  ...
  <meta property="og:title" content="Top Secret | GAME OVER Escape Rooms" />

  <meta property="og:url" content="https://www.escapegameover.com/rooms/top-secret.php" />

  <meta property="og:site_name" content="GAME OVER Escape Rooms " />

  <meta property="og:image" content="https://www.escapegameover.com/img/thumbs/topsecret.jpg" />

  <meta property="og:image:secure_url" content="https://www.escapegameover.com/img/thumbs/topsecret.jpg" />

  <meta name="twitter:card" content="summary" />

  <meta name="twitter:title" content="GAME OVER Escape Rooms " />

  <meta name="twitter:image" content="https://www.escapegameover.com/img/thumbs/topsecret.jpg" />
  ...
  <style media="screen">
    ...
    .room-top::after {
      ...
      background: url("../img/room_slider_images/mission(8).jpg") no-repeat center center;
...
<body id="page-top">
          ...
          <div class="" style="display: flex;justify-content: center;align-items: center;padding-bottom:40px;font-size:13px;">
            ...
            <ul class="text-left">
              ...
              <div class="lang">
                ...
                <a style="align-items:center;" href="../gr/rooms/top-secret.php">Greek</a>
              ...
              <div class="lang">
                ...
                <a href="../de/rooms/top-secret.php">German</a>
              ...
              <div class="lang">
                ...
                <a href="../it/rooms/top-secret.php">Italian</a>
              ...
              <div class="lang">
                ...
                <a href="../fr/rooms/top-secret.php">French</a>
              ...
              <div class="lang">
                ...
                <a href="../es/rooms/top-secret.php">Spanish</a>
  ...
  <?php include '../inc/en-carousel-top-secret.php'; ?>
  ...
  <section class="container-fluid room-top text-center " id="mainsect">
    ...
    <div class="info-container" style="">
      ...
      <div id="rooms" style="display: flex;align-items: center;justify-content:center;padding-top:50px;">
        ...
        <img src="../img/svg/top.svg" classs="img-fluid" alt="" style="width: 5rem;height:5rem;">

        <h1 style="display:inline-block;line-height:5rem;font-size:3rem;">TOP SECRET</h1>

      </div>



      <p class="room-desc" style="">An espionage escape game, in which the players have to escape a prison and <br>steal Top Secret Files by breaking into the high security Vault.
      ...
      <p class=" story" style="">The only way to get into this paramilitary headquarters, was to get caught and let the guards to bring you in as captives. So here you are! Now you have to escape the prison and break into the High Security Armored Vault to Steal their XJ7 missile blueprints and all their Top Secret Archive. Hurry up!
