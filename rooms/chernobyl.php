...
<head>
  ...
  <title>Chernobyl | GAME OVER Escape Rooms</title>

  <meta name="keywords" content="" />

  <meta name="description" content="Chernobyl | An adventure inside an old abandoned Reactor, hides a lot of secrets, puzzles and technology">
  ...
  <meta property="og:title" content="Chernobyl | GAME OVER Escape Rooms" />

  <meta property="og:url" content="https://www.escapegameover.com/chernobyl.php" />

  <meta property="og:site_name" content="GAME OVER Escape Rooms " />

  <meta property="og:image" content="https://www.escapegameover.com/img/thumbs/reactor.jpg" />

  <meta property="og:image:secure_url" content="https://www.escapegameover.com/img/thumbs/reactor.jpg" />

  <meta name="twitter:card" content="summary" />

  <meta name="twitter:title" content="GAME OVER Escape Rooms " />

  <meta name="twitter:image" content="https://www.escapegameover.com/img/thumbs/reactor.jpg" />
  ...
  <style media="screen">
    ...
    .room-reactor::after {
      ...
      background: url("../img/room_slider_images/reactor6.jpg") no-repeat center center;
...
<body id="page-top">
          ...
          <div class="" style="display: flex;justify-content: center;align-items: center;padding-bottom:40px;font-size:13px;">
            ...
            <ul class="text-left">
              ...
              <div class="lang">
                ...
                <a style="align-items:center;" href="../gr/rooms/chernobyl.php">Greek</a>
              ...
              <div class="lang">
                ...
                <a href="../de/rooms/chernobyl.php">German</a>
              ...
              <div class="lang">
                ...
                <a href="../it/rooms/chernobyl.php">Italian</a>
              ...
              <div class="lang">
                ...
                <a href="../fr/rooms/chernobyl.php">French</a>
              ...
              <div class="lang">
                ...
                <a href="../es/rooms/chernobyl.php">Spanish</a>
  ...
  <?php include '../inc/en-carousel-chernobyl.php'; ?>

  <!-- end of carousel -->

  <section class="container-fluid room-reactor text-center " id="mainsect">
    ...
    <div class="info-container" style="">
      ...
      <div id="rooms" style="display: flex;align-items: center;justify-content:center;line-height:5rem;padding-top:50px;">
        ...
        <img src="../img/svg/reactor.svg" classs="img-fluid" alt="" style="width: 5rem;height:5rem;">

        <h1 style="display:inline-block;line-height:5rem;">CHERNOBYL</h1>

      </div>

      <p class="room-desc" style="">An adventure inside an old abandoned Reactor, hides<br> a lot of secrets, puzzles and technology to let the players escape.
      ...
      <p class=" story" style="">This year, you and your friends decided to go for your annual holiday trip, in a cabin deep into the Krakov forest. The first day was a little bit boring, but then one of you discovered an abandoned Reactor in the woods. Tonight you are ready to live the most fascinating adventure of your life. ….so you enter the factory which is not as dead as it seems. Your adventure becomes a race to escape from this creepy place ASAP! Beware! The available oxygen seems to be for one hour so…. hurry up.</p>
