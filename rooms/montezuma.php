...
<head>
  ...
  <title>Forbidden Temple of Montezuma | GAME OVER Escape Rooms</title>

  <meta name="keywords" content="" />

  <meta name="description" content="Forbidden Temple of Montezuma | The room is a true representation of an ancient Aztec Temple in the Jungle.">
  ...
  <meta property="og:title" content="Forbidden Temple of Montezuma | GAME OVER Escape Rooms" />

  <meta property="og:url" content="https://www.escapegameover.com/rooms/montezuma/php" />

  <meta property="og:site_name" content="GAME OVER Escape Rooms " />

  <meta property="og:image" content="https://www.escapegameover.com/img/thumbs/montezuma.jpg" />

  <meta property="og:image:secure_url" content="https://www.escapegameover.com/img/thumbs/montezuma.jpg" />

  <meta name="twitter:card" content="summary" />

  <meta name="twitter:title" content="GAME OVER Escape Rooms " />

  <meta name="twitter:image" content="https://www.escapegameover.com/img/thumbs/montezuma.jpg" />



  <link rel="shortcut icon" href="../img/gameover_favicon.png">
  ...
  <style media="screen">
    ...
    .room-monte::after {
      ...
      background: url("../img/room_slider_images/montezuma (1).jpg") no-repeat center center;
...
<body id="page-top">
    ...
    <div class="burger-flag" style="">
      ...
      <div class="dropup-container" style="margin-top:-2px;">
        ...
        <div id="mySidenav" class="sidenav nav navbar-nav" style="overflow:hidden;">
          ...
          <div class="" style="display: flex;justify-content: center;align-items: center;padding-bottom:40px;font-size:13px;">#contact_form
            ...
            <ul class="text-left">
              ...
              <div class="lang">
                ...
                <a style="align-items:center;" href="../gr/rooms/montezuma.php">Greek</a>
              ...
              <div class="lang">
                ...
                <a href="../de/rooms/montezuma.php">German</a>
              ...
              <div class="lang">
                ...
                <a href="../it/rooms/montezuma.php">Italian</a>
              ...
              <div class="lang">
                ...
                <a href="../fr/rooms/montezuma.php">French</a>
              ...
              <div class="lang">
                ...
                <a href="../es/rooms/montezuma.php">Spanish</a>
  ...
  <?php include '../inc/en-carousel-montezuma.php'; ?>
  ...
  <section class="container-fluid room-monte text-center " id="mainsect">
    ...
    <div class="info-container" style="padding-top:50px;">
      ...
      <div id="rooms" style="display: flex;align-items: center;justify-content:center;line-height:5rem;">
        ...
        <img src="../img/svg/montezuma.svg" classs="img-fluid" alt="" style="width: 5rem;height:5rem;">

        <h1 class="text-left" style="display:inline-block;line-height:0.8;">FORBIDDEN TEMPLE<br> OF MONTEZUMA</h1>

      </div>

      <p class="room-desc" style="">The room is a true representation of an ancient Aztec Temple in the Jungle.<br> Tempting gameplay, a lot of technology behind the scenes and also high quality theming<br> scenorgaphy make this room unique.
      ...
      <p class=" story" style="">It’s been a lot of years than your professor at the Archaeologist University disappeared. You committed to each other to bring his research about the Aztecs in the light! So now, you are here, following his well encrypted tracks… But beware… What caused his loss may be upon you…
  ...
  <script src="../js/progress_bar_monte.js"></script>
