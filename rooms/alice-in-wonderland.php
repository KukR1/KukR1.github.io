...
<head>
    ...
    <meta name="description" content="An Adventure inside Alice’s Wonderland where players should escape in time.
An escape game that both kids and adults will love.">
    ...
    <meta property="og:image" content="https://www.escapegameover.com/img/thumbs/alice.jpg" />
    <meta property="og:image:secure_url" content="https://www.escapegameover.com/img/thumbs/alice.jpg" />
    <meta name="twitter:card" content="summary" />
    <meta name="twitter:title" content="GAME OVER Escape Rooms " />
    <meta name="twitter:image" content="https://www.escapegameover.com/img/thumbs/alice.jpg" />
    ...
    <style media="screen">
        ...
        .alice::after {
            content: "";
            background: url("../img/mobile_thumbs/alice_in_wonderland.jpg") no-repeat center center;
            opacity: 0.2;
            top: 0;
            left: 0;
            bottom: 0;
...
<body id="page-top">
    ...
    </div> <!-- end of container fluid --> <?php include '../inc/carousel-alice-in-wonderland.php'; ?> <section class="container-fluid alice text-center " id="mainsect">
        <div class="blur-div-2"></div>
        <div class="info-container" style="">
            <div id="rooms" class="" style="display: flex;align-items: center;justify-content:center;padding-top:50px;"> <img src="../img/svg/alice.svg" classs="img-fluid" alt="" style="width: 5rem;height:5rem;">
                <h1 style="display:inline-block;line-height:5rem;font-size:3rem;">ALICE IN WONDERLAND</h1>
            </div>
            <p class="room-desc" style="">An Adventure inside Alice’s Wonderland where players should escape in time.<br>
                An escape game that both kids and adults will love.</p>
