...
<head>
  ...
  <meta name="description" content="Lost City Of Atlantis | An underwater part of the lost city of Atlantis, one of the greatest mysteries of all time ">
  ...
  <meta property="og:url" content="https://www.escapegameover.com/rooms/lost-city-of-atlantis.php" />
  <meta property="og:site_name" content="GAME OVER Escape Rooms " />
  <meta property="og:image" content="https://www.escapegameover.com/img/thumbs/atlantis.jpg" />
  <meta property="og:image:secure_url" content="https://www.escapegameover.com/img/thumbs/atlantis.jpg" />
  <meta name="twitter:card" content="summary" />
  <meta name="twitter:title" content="GAME OVER Escape Rooms " />
  <meta name="twitter:image" content="https://www.escapegameover.com/img/thumbs/atlantis.jpg" />
...
<body id="page-top">
          ...
          <div class="" style="display: flex;justify-content: center;align-items: center;padding-bottom:40px;font-size:13px;">
            <ul class="text-left">
              ...
              <div class="lang">
                ...
                <a href="../fr/rooms/lost-city-of-atlantis.php">French</a>
              </div>
              <div class="lang">
  ...
  <!-- carousel -->
  <?php include '../inc/en-carousel-lost-city-of-atlantis.php'; ?>
  ...
  <section class="container-fluid room-lost text-center " id="mainsect">
    ...
    <div class="info-container" style="padding-top:50px;">
      ...
      <p class="room-desc" style="">An underwater part of the lost city of Atlantis, one of the greatest mysteries of all
        <br>time.
      ...
      <p class=" story" style="">After many years of research and translation of hundreds of ancient scripts, you are here! <br>
        If you are right the discovery of Atlantis is a fact that will rewrite the World’s History, thanks to you! The ancient ruins you are watching right now, hide mysteries way bigger than every known legend, and also the danger of your extinction along with Atlantis herself!</p>
    </div>
    ...
    <div class="" style="padding-bottom: 30px;">
      ...
      <p>** The themed ceiling comes as an additional feature</p>
