...
<head>
    ...
    <title>DRACULA | GAME OVER Escape Rooms</title>
    ...
    <meta property="og:title" content="DRACULA | GAME OVER Escape Rooms" />
    <meta property="og:url" content="https://www.escapegameover.com/rooms/dracula.php" />
    ...
    <style media="screen">
        ...
        .dracula::after {
            content: "";
            background: url("/img/room_slider_images/dracula/8.jpg") no-repeat center center;
            opacity: 0.2;
            top: 0;
            left: 0;
            bottom: 0;
    ...
    <div class="container-fluid nav-container p-0 fixed-top" style=""> <?php include '../inc/logo.php'; ?> <?php include '../inc/menu-tabs.php'; ?> <div class="burger-flag" style="">
            ...
            <div class="dropup-container" style="margin-top:-2px;">
                ...
                <div id="mySidenav" class="sidenav nav navbar-nav" style="overflow:hidden;"> <button class="closebtn">&times;</button>
                    ...
                    <div class="" style="display: flex;justify-content: center;align-items: center;padding-bottom:40px;font-size:13px;">
                        <ul class="text-left">
                            <div class="lang"> <img style="border-radius:50%;align-self: center;width:13px;" src="/img/flags/gr.svg" alt="GAME OVER - Greek"> <a href="/gr/rooms/dracula.php">Greek</a> </div>
                            <div class="lang"> <img style="border-radius:50%;align-self: center;width:13px;" src="/img/flags/de.svg" alt="GAME OVER - German"> <a href="/de/rooms/dracula.php">German</a> </div>
                            <div class="lang"> <img style="border-radius:50%;align-self: center;width:13px;" src="/img/flags/it.svg" alt="GAME OVER - Italian"> <a href="/it/rooms/dracula.php">Italian</a> </div>
                            <div class="lang"> <img style="border-radius:50%;align-self: center;width:13px;" src="/img/flags/fr.svg" alt="GAME OVER - French"> <a href="/fr/rooms/dracula.php">French</a> </div>
                            <div class="lang"> <img style="border-radius:50%;align-self: center;width:13px;" src="/img/flags/es.svg" alt="GAME OVER - Spanish"> <a href="/es/rooms/dracula.php">Spanish</a> </div>
                        </ul>
                    </div>
                </div>
            </div>
        </div>
    </div> <!-- end of container fluid --> <?php include '../inc/carousel-dracula.php'; ?> <section class="container-fluid dracula text-center " id="mainsect">
        <div class="blur-div-2"></div>
        <div class="info-container" style="">
            <div id="rooms" class="" style="display: flex;align-items: center;justify-content:center;padding-top:50px;"> <img src="/img/svg/dracula.svg" classs="img-fluid" alt="" style="width: 5rem;height:5rem;">
        ...
        <div class="progress-container mt-5 pb-5 " style="text-align:right;">
            ...
            <div class="progress" style="">
                <div class="progress-bar" role="progressbar" style="width: 80%; background-color:#da1a35;" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
            </div>
