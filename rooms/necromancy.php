...
<head>
  ...
  <meta property="og:image" content="https://www.escapegameover.com/img/thumbs/necromancy.jpg" />

  <meta property="og:image:secure_url" content="https://www.escapegameover.com/img/thumbs/necromancy.jpg" />

  <meta name="twitter:card" content="summary" />

  <meta name="twitter:title" content="GAME OVER Escape Rooms " />

  <meta name="twitter:image" content="https://www.escapegameover.com/img/thumbs/necromancy.jpg" />
...
<?php include '../inc/en-carousel-necromancy.php'; ?>
...
<div class="right-icon"></div>
    ...
    <img src="../img/menus_logo/quote.svg" alt="" style="margin:30px;height:3rem;width:3rem;" >
      ...
      <p class=" story" style="">Somewhere in town, exists an old house that everyone avoids . The spirits that are imprisoned there are eternally immersed in a nightmare without an end. However you should not only explore the old mansion, but also call the lost souls from their macabre lethargy, even if that means practicing the forbidden art of Necromantia. No one knows what you will discover there, as no one has returned from this house alive – or even dead …</p>
