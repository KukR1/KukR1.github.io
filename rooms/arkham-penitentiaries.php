...
<head>
  ...
  <title>Arkham Penitentiaries | GAME OVER Escape Rooms</title>

  <meta name="keywords" content="" />

  <meta name="description" content="Drawing inspiration from the greatest deco investigation comics of our time, <br>

    Arkham Prison pits the players against the criminal masterminds that run the city.">
  ...
  <meta property="og:url" content="https://www.escapegameover.com/rooms/arkham-penitentiaries.php" />

  <meta property="og:site_name" content="GAME OVER Escape Rooms " />

  <meta property="og:image" content="https://www.escapegameover.com/img/thumbs/arkham.jpg" />

  <meta property="og:image:secure_url" content="https://www.escapegameover.com/img/thumbs/arkham.jpg" />

  <meta name="twitter:card" content="summary" />

  <meta name="twitter:title" content="GAME OVER Escape Rooms " />

  <meta name="twitter:image" content="https://www.escapegameover.com/img/thumbs/arkham.jpg" />
...
<body id="page-top">
          ...
          <div class="" style="display: flex;justify-content: center;align-items: center;padding-bottom:40px;font-size:13px;">
            ...
            <ul class="text-left">
              ...
              <div class="lang">
                ...
                <a style="align-items:center;" href="../gr/rooms/arkham-penitentiaries.php">Greek</a>
              ...
              <div class="lang">
                ...
                <a href="../it/rooms/arkham-penitentiaries.php">Italian</a>#contact_form
  ...
  <?php include '../inc/en-carousel-arkham-penitentiaries.php'; ?>
  ...
  <section class="container-fluid arkham text-center " id="mainsect">
    ...
    <div class="info-container" style="">
      ...
      <p class="room-desc" style="">Drawing inspiration from the greatest deco investigation comics of our time, <br>
      ...
      <p class=" story" style="">During the Arkham Prison Riots, one of the most dangerous supervillains has managed to escape his holding cell.

        His plan, if allowed to come to fruition,

        will have the most devastating consequences for the entire city. You and your team are oul last hope - infiltrate the prison ,

        gather clues left behind & put an end to this madness before it's too late .</p>
