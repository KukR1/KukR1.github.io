...
<head>
  ...
  <meta property="og:image" content="https://www.escapegameover.com/img/thumbs/maniac.jpg" />

  <meta property="og:image:secure_url" content="https://www.escapegameover.com/img/thumbs/maniac.jpg" />

  <meta name="twitter:card" content="summary" />

  <meta name="twitter:title" content="GAME OVER Escape Rooms " />

  <meta name="twitter:image" content="https://www.escapegameover.com/img/thumbs/maniac.jpg" />
...
<body id="page-top">
  ...
  <?php include '../inc/en-carousel-maniac.php'; ?>
  ...
  <section class="container-fluid room-maniac text-center " id="mainsect">
    ...
    <div class="info-container" style="padding-top:50px;">
      ...
      <p class=" story" style="">You wake up in the dark, something feels terribly wrong. Your fears are realized when you hear a voice saying “I want to play a game”. You’re sitting in the case of Jigsaw and you know that everything is against you. Your only chance to survive is to follow his crazy missions and find the right time to escape! The time is running…</p>
