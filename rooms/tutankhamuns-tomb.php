...
<head>
  ...
  <title>Tutankhamun's Tomb | GAME OVER Escape Rooms</title>

  <meta name="keywords" content="" />

  <meta name="description" content="Tutankhamun's Tomb | This room is a vivid representation of an ancient, Egyptian pyramid’s inside. ">
  ...
  <meta property="og:title" content="Tutankhamun's Tomb | GAME OVER Escape Rooms" />

  <meta property="og:url" content="https://www.escapegameover.com/rooms/tutankhamuns-tomb.php" />

  <meta property="og:site_name" content="GAME OVER Escape Rooms " />

  <meta property="og:image" content="https://www.escapegameover.com/img/thumbs/tutankhamun.jpg" />

  <meta property="og:image:secure_url" content="https://www.escapegameover.com/img/thumbs/tutankhamun.jpg" />

  <meta name="twitter:card" content="summary" />

  <meta name="twitter:title" content="GAME OVER Escape Rooms " />

  <meta name="twitter:image" content="https://www.escapegameover.com/img/thumbs/tutankhamun.jpg" />
  ...
  <style>
    ...
    .room-tut::after {
      ...
      background: url("../img/room_slider_images/tut (3).jpg") no-repeat center center;
...
<body id="page-top">
          ...
          <div class="" style="display: flex;justify-content: center;align-items: center;padding-bottom:40px;font-size:13px;">
            ...
            <ul class="text-left">
              <div class="lang">
                ...
                <a style="align-items:center;" href="../gr/rooms/tutankhamuns-tomb.php">Greek</a>
              ...
              <div class="lang">
                ...
                <a href="../de/rooms/tutankhamuns-tomb.php">German</a>
              ...
              <div class="lang">
                ...
                <a href="../it/rooms/tutankhamuns-tomb.php">Italian</a>
              ...
              <div class="lang">
                ...
                <a href="../fr/rooms/tutankhamuns-tomb.php">French</a>
              ...
              <div class="lang">
                ...
                <a href="../es/rooms/tutankhamuns-tomb.php">Spanish</a>
  ...
  <?php include '../inc/en-carousel-tutankhamuns-tomb.php'; ?>
  ...
  <section class="container-fluid room-tut text-center " id="mainsect">

    <div class="blur-div-2"></div>

    <div class="info-container" style="">

      <div id="roomstut" style="display: flex;align-items: center;justify-content:center;padding-top:50px;">

        <img src="../img/svg/tut.svg" classs="img-fluid" alt="" style="width: 5rem;height:5rem;">

        <h1 style="display:inline-block;line-height:5rem;font-size:3rem;">TUTANKHAMUN'S TOMB</h1>

      </div>



      <p class="room-desc" style="">This room is a vivid representation of an ancient,<br> Egyptian pyramid’s inside. A very

        <br>scenographically and technologically advanced room.
      ...
      <p class=" story" style="">Now you have reached the main hall. If you open this door, <br>

        you can find out the secret of the great Pharaoh. But be careful!

        If you stay longer than an hour here, his curse will come upon you forever.</p>
