...
Sound and Visual effects combination increase the player’s experience. ">
  ...
  <meta property="og:url" content="https://www.escapegameover.com/rooms/haunted-mansion.php" />
  <meta property="og:site_name" content="GAME OVER Escape Rooms " />
  <!-- <meta property="og:image" content="https://www.escapegameover.com/img/thumbs/choco.jpg" /> -->
  <!-- <meta property="og:image:secure_url" content="https://www.escapegameover.com/img/thumbs/choco.jpg" /> -->
  <meta name="twitter:card" content="summary" />
  <meta name="twitter:title" content="GAME OVER Escape Rooms " />
  <!-- <meta name="twitter:image" content="https://www.escapegameover.com/img/thumbs/choco.jpg" /> -->
...
<!-- carousel -->
<?php include '../inc/en-carousel-haunted-mansion.php'; ?>
<!-- end of carousel -->
...
<section class="container-fluid room-choco text-center " id="mainsect">
  ...
  <div class="info-container" style="padding-top:50px;">
    ...
    <p class="room-desc" style="">An innovative horror room with intensive & unique atmosphere. <br/>Combination of visual, sound & jump-scare effects, offer players an ultimate gaming experience.
    </p>
...
<div class="right-icon"></div>
    ...
    <p class=" story" style="">You are the most experienced “investigators of the supernatural”. Your team was approached by a mysterious man who offered you a huge amount of money, to get inside a specific Mansion and search for a powerful ancient Artifact. 
He artfully avoided informing you about all the previous investigators he had hired, that never came back...</p>
  </div>
...
<p>*  The piano comes as an additional feature</p>
