...
<head>
  ...
  <title>Pirates Of Caribbean | GAME OVER Escape Rooms</title>
  <meta name="keywords" content="" />
  <meta name="description" content=" Pirates Of Caribbean | In this room the players sneak into Blackbeard’s cabin, inside his famous ship Queen Anne’s Revenge. ">
  ...
  <meta property="og:title" content="Pirates Of Caribbean | GAME OVER Escape Rooms" />
  <meta property="og:url" content="https://www.escapegameover.com/pirates-of-caribbean.php" />
  <meta property="og:site_name" content="GAME OVER Escape Rooms " />
  <meta property="og:image" content="https://www.escapegameover.com/img/thumbs/pirates.jpg" />
  <meta property="og:image:secure_url" content="https://www.escapegameover.com/img/thumbs/pirates.jpg" />
  <meta name="twitter:card" content="summary" />
  <meta name="twitter:title" content="GAME OVER Escape Rooms " />
  <meta name="twitter:image" content="https://www.escapegameover.com/img/thumbs/pirates.jpg" />
  ...
  <style media="screen">
    ...
    .room-pirates::after {
      content: "";
      background: url("../img/room_slider_images/pirates (4).jpg") no-repeat center center;
      opacity: 0.2;
      top: 0;
      left: 0;
      bottom: 0;
...
<body id="page-top">
  ...
  <!-- carousel -->
  <?php include '../inc/en-carousel-pirates-of-caribbean.php'; ?>
  ...
  <section class="container-fluid room-pirates text-center " id="mainsect">
    ...
    <div class="info-container" style="">
      <div id="rooms" style="display: flex;align-items: center;justify-content:center;line-height:5rem;padding-top:50px;">
        <img src="../img/svg/pirates.svg" classs="img-fluid" alt="" style="width: 5rem;height:5rem;">
        <h1 style="display:inline-block;line-height:5rem;">PIRATES OF CARIBBEAN</h1>
      </div>
      <p class="room-desc" style=""> In this room the players sneak into Pearl’s cabin, the ship of a mighty Pirate, <br>
        to search the map with the locations of the famous "5 treasures of Caribbean"
      </p>
      ...
      <p class=" story" style="">The 5 treasures of the Caribbean is one of the oldest legends of the New World.
        A lot of privateers and pirates, but even admirals of England or Spain, tried to spot the 5 locations,
        but only one managed to complete the map. Captain Rackham keeps the map inside his cabin
        and by the dawn he sails to the 1st location. One hour left for you to sneak in and claim the map!
      </p>
    </div>
