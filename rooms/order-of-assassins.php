...
<head>
  ...
  <meta name="description" content="Order Of Assassins | This room is a vivid representation of a Templar Tomb built in the Middle Ages.">
  ...
  <meta property="og:image" content="https://www.escapegameover.com/img/thumbs/assassins.jpg" />

  <meta property="og:image:secure_url" content="https://www.escapegameover.com/img/thumbs/assassins.jpg" />

  <meta name="twitter:card" content="summary" />

  <meta name="twitter:title" content="GAME OVER Escape Rooms " />

  <meta name="twitter:image" content="https://www.escapegameover.com/img/thumbs/assassins.jpg" />
  ...
  <style media="screen">
    ...
    .room-order::after {
      ...
      background: url("../img/room_slider_images/assassins/assassins (1).jpg") no-repeat center center;
...
<body id="page-top">
    ...
    <div class="burger-flag" style="">
      ...
      <div class="dropup-container" style="margin-top:-2px;">
        ...
        <div id="mySidenav" class="sidenav nav navbar-nav" style="overflow:hidden;">
          ...
          <p class="text-center" style="color:white;font-size:17px;margin:25px 0;font-weight:300;width:100%;">CHOOSE LANGUAGE</p>#contact_form
          ...
          <div class="" style="display: flex;justify-content: center;align-items: center;padding-bottom:40px;font-size:13px;">
            ...
            <ul class="text-left">
              ...
              <div class="lang">
                ...
                <a style="align-items:center;" href="../gr/rooms/order-of-assassins.php">Greek</a>
              ...
              <div class="lang">
                ...
                <a href="../it/rooms/order-of-assassins.php">Italian</a>
  ...
  <?php include '../inc/en-carousel-order-of-assassins.php'; ?>
  ...
  <section id="mainsect" class="container-fluid room-order text-center">
    ...
    <div class="info-container" style="padding-top:50px;">
      ...
      <p class="room-desc" style="">This room is a vivid representation of a Templar Tomb built in the Middle Ages.<br> Breathtaking effects and wow factors, immersive atmosphere combined with a lot of mechatronics <br>and premium quality scenography, provide a unique outcome.
      ...
      <section class="icon-section">
        ...
        <div class="room-icon" style="">
          ...
          <div class="small-box text-center" style="">
            ...
            <p class="pdesc">Adventure - <br>Historical</p>
      ...
      <p class=" story" style="">1291 aD. After the fall of Acre, the Templars returned in Europe, bringing with them their legacy & the greatest treasure of mankind, the Apple of Eden...



        Today. The ancient papyrus sheet you are holding has written only a few words:



        "This... piece of silver cast out Adam and Eve. It turned staves into snakes. Parted & closed the Red Sea. Eris used it to start the Trojan War; & with it, a poor carpenter turned water into wine. May the last of us, be its Eternal Guardian" So you are in Malta, in front of the grave of Last Templar Magister that left alive from Acre...
