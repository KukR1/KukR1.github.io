...
<head>
  ...
  <meta name="description" content=" Pirates - Queen Anne's Revenge | Representation of the notorious Queen Anne’s Revenge, ship of the mighty Blackbeard. <br>
...
Technology, embedded into great set designs and props makes the ship “alive”. ">
  ...
  <meta property="og:image" content="https://www.escapegameover.com/img/thumbs/pirates_ext.jpg" />

  <meta property="og:image:secure_url" content="https://www.escapegameover.com/img/thumbs/pirates_ext.jpg" />

  <meta name="twitter:card" content="summary" />

  <meta name="twitter:title" content="GAME OVER Escape Rooms " />

  <meta name="twitter:image" content="https://www.escapegameover.com/img/thumbs/pirates_ext.jpg" />
...
<body id="page-top">
          ...
          <div class="" style="display: flex;justify-content: center;align-items: center;padding-bottom:40px;font-size:13px;">
            ...
            <ul class="text-left">
              ...
              <div class="lang">
                ...
                <a style="align-items:center;" href="../gr/rooms/queen-annes-revenge.php">Greek</a>
              ...
              <div class="lang">
                ...
                <a href="../it/rooms/queen-annes-revenge.php">Italian</a>
  ...
  <?php include '../inc/en-carousel-queen-annes-revenge.php'; ?>
  ...
  <section class="container-fluid room-pirates text-center " id="mainsect">
    ...
    <div class="info-container" style="">
      ...
      <p class="room-desc" style="">Representation of the notorious Queen Anne’s Revenge, ship of the mighty Blackbeard. <br>
      ...
      <p class=" story" style="">When you planed your operation in the Tavern, everything seemed logic and doable...

        Now, standing at Tortuga's bay at midnight and looking at her

        with your souls full of dread, nothing seems so logic.

        You are so close to the most valuable item in Pirate's world,

        however nobody climbed in Queen Anne's Revenge and returned to tell the story.

        You know that dawn, will bring Blackbeard and his crew back to the ship, so your only chance is now...
