...
<body id="page-top">
    <div class="container-fluid nav-container p-0 fixed-top" style=""> <?php include '../inc/logo.php'; ?> <?php include '../inc/menu-tabs.php'; ?> <div class="burger-flag" style="">
    ...
    </div> <!-- end of container fluid --> <?php include '../inc/carousel-horror-circus.php'; ?> <section class="container-fluid circus text-center " id="mainsect">
        ...
        <div class="info-container" style="">
            ...
            <p class="room-desc" style="">A Horror Escape Game inside a Cursed Circus, full of scary effects and amazing atmosphere.<br>
                High technologies and wow factors embedded in the great scenography, make this room really<br>
