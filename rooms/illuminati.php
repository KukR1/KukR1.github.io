...
<body id="page-top">
    <div class="container-fluid nav-container p-0 fixed-top" style=""> <?php include '../inc/logo.php'; ?> <?php include '../inc/menu-tabs.php'; ?> <div class="burger-flag" style="">
            ...
            <div class="dropup-container" style="margin-top:-2px;">
                ...
                <div id="mySidenav" class="sidenav nav navbar-nav" style="overflow:hidden;"> <button class="closebtn">&times;</button>
                    ...
                    <div class="" style="display: flex;justify-content: center;align-items: center;padding-bottom:40px;font-size:13px;">
                        <ul class="text-left">
                            <div class="lang"> <img style="border-radius:50%;align-self: center;width:13px;" src="../img/flags/gr.svg" alt="GAME OVER - Greek"> <a style="align-items:center;" href="#">Greek</a> </div>
                            <div class="lang"> <img style="border-radius:50%;align-self: center;width:13px;" src="../img/flags/de.svg" alt="GAME OVER - German"> <a href="#">German</a> </div>
                            <div class="lang"> <img style="border-radius:50%;align-self: center;width:13px;" src="../img/flags/it.svg" alt="GAME OVER - Italian"> <a href="#">Italian</a> </div>
                            <div class="lang"> <img style="border-radius:50%;align-self: center;width:13px;" src="../img/flags/fr.svg" alt="GAME OVER - French"> <a href="#">French</a> </div>
                            <div class="lang"> <img style="border-radius:50%;align-self: center;width:13px;" src="../img/flags/es.svg" alt="GAME OVER - Spanish"> <a href="#">Spanish</a> </div>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="info-container" style="">
            ...
            <p class="room-desc" style="">You have the chance to reveal the deepest secrets of the Illuminati conspiracy and find the<br>
                Legendary Holy Grail. Amazing storyline and challenging gameplay, including technologically<br>
                advanced games, make this room really popular.</p>
