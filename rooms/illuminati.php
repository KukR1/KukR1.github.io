...
<head>
    ...
    <title>Illuminati | GAME OVER Escape Rooms</title>
    <meta name="keywords" content="" />
    <meta name="description" content="You have the chance to reveal the deepest secrets of the Illuminati conspiracy and find the
    ...
    <meta property="og:title" content="Illuminati | GAME OVER Escape Rooms" />
    <meta property="og:url" content="https://www.escapegameover.com/rooms/illuminati.php" />
    <meta property="og:site_name" content="GAME OVER Escape Rooms " />
    <meta property="og:image" content="https://www.escapegameover.com/img/thumbs/illuminati.jpg" />
    <meta property="og:image:secure_url" content="https://www.escapegameover.com/img/thumbs/illuminati.jpg" />
    ...
    <style media="screen">
        ...
        .illuminati::after {
            content: "";
            background: url("../img/mobile_thumbs/illuminati.jpg") no-repeat center center;
            opacity: 0.2;
            top: 0;
            left: 0;
            bottom: 0;
...
<body id="page-top">
    <div class="container-fluid nav-container p-0 fixed-top" style=""> <?php include '../inc/logo.php'; ?> <?php include '../inc/menu-tabs.php'; ?> <div class="burger-flag" style="">
            ...
            <div class="dropup-container" style="margin-top:-2px;">
                ...
                <div id="mySidenav" class="sidenav nav navbar-nav" style="overflow:hidden;"> <button class="closebtn">&times;</button>
                    ...
                    <div class="" style="display: flex;justify-content: center;align-items: center;padding-bottom:40px;font-size:13px;">
                        <ul class="text-left">
                            <div class="lang"> <img style="border-radius:50%;align-self: center;width:13px;" src="/img/flags/gr.svg" alt="GAME OVER - Greek"> <a href="/gr/rooms/illuminati.php">Greek</a> </div>
                            <div class="lang"> <img style="border-radius:50%;align-self: center;width:13px;" src="/img/flags/de.svg" alt="GAME OVER - German"> <a href="/de/rooms/illuminati.php">German</a> </div>
                            <div class="lang"> <img style="border-radius:50%;align-self: center;width:13px;" src="/img/flags/it.svg" alt="GAME OVER - Italian"> <a href="/it/rooms/illuminati.php">Italian</a> </div>
                            <div class="lang"> <img style="border-radius:50%;align-self: center;width:13px;" src="/img/flags/fr.svg" alt="GAME OVER - French"> <a href="/fr/rooms/illuminati.php">French</a> </div>
                            <div class="lang"> <img style="border-radius:50%;align-self: center;width:13px;" src="/img/flags/es.svg" alt="GAME OVER - Spanish"> <a href="/es/rooms/illuminati.php">Spanish</a> </div>
                        </ul>
                    </div>
                </div>
            </div>
        </div>
    </div> <!-- end of container fluid --> <?php include '../inc/carousel-illuminati.php'; ?> <section class="container-fluid illuminati text-center " id="mainsect">
        <div class="blur-div-2"></div>
        <div class="info-container" style="">
            <div id="rooms" class="" style="display: flex;align-items: center;justify-content:center;padding-top:50px;"> <img src="../img/svg/illuminati.svg" classs="img-fluid" alt="" style="width: 5rem;height:5rem;">
                <h1 style="display:inline-block;line-height:5rem;font-size:3rem;">ILLUMINATI</h1>
            </div>
            <p class="room-desc" style="">
                You have the chance to reveal the deepest secrets of the Illuminati conspiracy and find the<br>
                Legendary Holy Grail. Amazing storyline and challenging gameplay, including technologically<br>
                advanced games, make this room really popular.
            </p>
        ...
        <div class="progress-container mt-5 pb-5 " style="text-align:right;">
            <div class="div1" style="height:20px;">
                <p class="percent" style="display:inline-block;">97%</p><br>
            </div>
    ...
    <script src="../js/progress_bar_illuminati.js"></script>
