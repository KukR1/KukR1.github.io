...
<head>
  ...
  <title>Minotaur's Labyrinth | GAME OVER Escape Rooms</title>

  <meta name="keywords" content="" />

  <meta name="description" content=" Minotaur's Labyrinth | This room is a representation of King Mino’s Labyrinth in ancient Crete.">
  ...
  <meta property="og:title" content="Minotaur's Labyrinth | GAME OVER Escape Rooms" />

  <meta property="og:url" content="https://www.escapegameover.com/rooms/mino.php" />

  <meta property="og:site_name" content="GAME OVER Escape Rooms " />

  <meta property="og:image" content="https://www.escapegameover.com/img/thumbs/mino.jpg" />

  <meta property="og:image:secure_url" content="https://www.escapegameover.com/img/thumbs/mino.jpg" />

  <meta name="twitter:card" content="summary" />

  <meta name="twitter:title" content="GAME OVER Escape Rooms " />

  <meta name="twitter:image" content="https://www.escapegameover.com/img/thumbs/mino.jpg" />
  ...
  <style media="screen">
    ...
    .room-mino::after {
      ...
      background: url("../img/room_slider_images/mino (1).jpg") no-repeat center center;
...
<body id="page-top">
    ...
    <div class="burger-flag" style="">
      ...
      <div class="dropup-container" style="margin-top:-2px;">
        ...
        <div id="mySidenav" class="sidenav nav navbar-nav" style="overflow:hidden;">
          ...
          <button class="closebtn">&times;</button>#contact_form
          ...
          <div class="" style="display: flex;justify-content: center;align-items: center;padding-bottom:40px;font-size:13px;">
            ...
            <ul class="text-left">
              ...
              <div class="lang">
                ...
                <a style="align-items:center;" href="../gr/rooms/mino.php">Greek</a>
              ...
              <div class="lang">
                ...
                <a href="../de/rooms/mino.php">German</a>
              ...
              <div class="lang">
                ...
                <a href="../it/rooms/mino.php">Italian</a>
              ...
              <div class="lang">
                ...
                <a href="../fr/rooms/mino.php">French</a>
              ...
              <div class="lang">
                ...
                <a href="../es/rooms/mino.php">Spanish</a>
  ...
  <?php include '../inc/en-carousel-mino.php'; ?>
  ...
  <section class="container-fluid room-mino text-center " id="mainsect">

    <div class="blur-div-2"></div>

    <div class="info-container" style="padding-top:50px;">

      <div id="rooms" class="mt-5" style="display: flex;align-items: center;justify-content:center;line-height:5rem;">

        <img src="../img/svg/mino.svg" classs="img-fluid" alt="" style="width: 5rem;height:5rem;">

        <h1 style="display:inline-block;line-height:5rem;font-size:2rem;">MINOTAUR'S LABYRINTH</h1>

      </div>

      <p class="room-desc" style="">This room is a representation of King Mino’s Labyrinth in ancient Crete.<br> A very popular Greek mythology theme, with challenging game play consisted of 19 steps.
      ...
      <p class=" story" style="">Congratulations! You saved your life by killing the ferocious Minotaur but that was not the hardest challenge. Now you have 1 hour to find your way out of the labyrinth<br> before King Mino's comes with his soldiers.
  ...
  <script src="../js/progress_bar_mino.js"></script>
