...
<head>
  ...
  <title>Winter Is Coming | GAME OVER Escape Rooms</title>
  <meta name="keywords" content="" />
  <meta name="description" content="The story is taking part into the famous Castle Black of Game of Thrones tv series
  and your mission is to save the world from the dead.">
  ...
  <meta property="og:title" content="Winter Is Coming | GAME OVER Escape Rooms" />
  <meta property="og:url" content="https://www.escapegameover.com/rooms/winter-is-coming.php" />
  <meta property="og:site_name" content="GAME OVER Escape Rooms " />
  <meta property="og:image" content="https://www.escapegameover.com/img/thumbs/wic.jpg" />
  <meta property="og:image:secure_url" content="https://www.escapegameover.com/img/thumbs/wic.jpg" />
  <meta name="twitter:card" content="summary" />
  <meta name="twitter:title" content="GAME OVER Escape Rooms " />
  <meta name="twitter:image" content="https://www.escapegameover.com/img/thumbs/wic.jpg" alt="Τhrone Ιmage"/>
...
.room-winter {
  ...
  .room-winter::after {
    content: "";
    background:url("../img/room_slider_images/got (1).jpg") no-repeat center center ;
    opacity: 0.2;
    top: 0;
    left: 0;
    bottom: 0;
...
<div class="container-fluid nav-container p-0 fixed-top" style="">
  ...
  <div class="burger-flag" style="">
    <div class="burger-container  ">
        ...
        <img class="dropbtn" style="width:25px;" src="../img/flags/select.svg" alt="Select Language">
...
<!-- carousel -->
<?php include '../inc/en-carousel-winter-is-coming.php'; ?>

<!-- end of carousel -->

<section class="container-fluid room-winter text-center " id="mainsect">
  ...
  <div class="info-container" style="">
    <div id="rooms" class="" style="display: flex;align-items: center;justify-content:center;padding-top:50px;">
      <img src="../img/svg/got.svg" classs="img-fluid" alt="" style="width: 5rem;height:5rem;">
      <h1 style="display:inline-block;line-height:5rem;font-size:3rem;">WINTER IS COMING</h1>
    </div>

    <p class="room-desc" style=""> The story is taking part into the famous Castle Black of Game of Thrones tv series

      <br>and your mission is to save the world from the dead.<br> A very scenographically and technologically
      advanced room.
    ...
    <div class="room-icon" style="">
        ...
        <div class="small-box text-center" style="">
          ...
          <p class="pdesc">30-35m<sup>2</sup></p>
        </div>
...
<div class="right-icon"></div>
    ...
    <p class=" story" style="">The White Walkers crossed the wall and are everywhere! The world has a new enemy and <br>
       the worst? Looks invincible! The only hope left is an old script of Grand Maester about a
      weapon against winter that is hidden in the ice wall! Representatives from all the major Houses have gathered in Castle Black but failed to find anything …
      But perhaps the hall conceals more than it seems?</p>
  </div>
  ...
  <div class="" style="padding-bottom: 30px;">
    <p style="margin-bottom:1vh;">* The iron throne is an extra optional feature</p>
    <p>** Themed ceiling comes as additional feature</p>
  </div>
