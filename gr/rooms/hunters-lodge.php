...
<head>
  ...
  <meta name="description" content="Hunter's Lodge | Aληθινή αναπαράσταση ενός καταφύγιου ενός κυνηγού,  και ένα συναρπαστικό σενάριο για να αποδράσετε.">
            ...
            <div class="" style="display: flex;justify-content: center;align-items: center;padding-bottom:40px;font-size:13px;">
              ...
              <div class="lang">
                  ...
                  <div class="lang">
                    ...
                    <a style="align-items:center;" href="../../it/rooms/hunters-lodge.php">Italian</a>
                  </div>
                  <div class="lang">
...
<section class="container-fluid room-lodge text-center " id="mainsect">
  ...
  <div class="info-container" style="padding-top:50px;">
    <div id="rooms" style="display: flex;align-items: center;justify-content:center;padding-top:50px;">
      ...
      <h1 style="display:inline-block;line-height:5rem;font-size:3rem;">HUNTER'S LODGE</h1>
    </div>
    <p class="room-desc">Aληθινή αναπαράσταση ενός καταφύγιου ενός κυνηγού, <br>
       και ένα συναρπαστικό σενάριο για να αποδράσετε. <br>
        Καταπληκτική ατμόσφαιρα και παιχνίδι που περιλαμβάνει <br>
        αινίγματα και παιχνίδια συνδεδεμένα με το θέμα.
    </p>
...
<div class="right-icon"></div>
    ...
    <p class=" story">
Η περιπέτεια σας στο δάσος έχει πάει στραβά εξαιτίας της μεγάλης χιονοθύελλας που ξαφνικά προέκυψε.
 Ευτυχώς, στον ορίζοντα εμφανίστηκε ένα φως και μετά από μερικά λεπτά περπατώντας μέσα στο χιόνι, βρίσκεστε σε μια καμπίνα στο δάσος.
 Προφανώς, ένας κυνηγός ζει εδώ, αλλά μετά από μερικά λεπτά καταλαβαίνετε ότι ίσως αυτό δεν είναι το κατάλυμα του κυνηγού,
  αλλά η παγίδα του κυνηγού. Είσαι το θύμα ή όχι; 60 λεπτά παραμένουν για να βρείτε την απάντηση!</p>
  </div>
