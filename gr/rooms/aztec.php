...
<head>
  ...
  <meta name="description" content=" Aztec Empire - Temple of the Skull |   Αυτό το δωμάτιο προσφέρει μια καταπληκτική εμπειρία σε εναν τεράστιο χώρο άνω των 85 τετραγωνικών μέτρων .">
  ...
  <section class="container-fluid room-aztec text-center " id="mainsect">
    ...
    <div class="info-container" style="">
      ...
      <p class="room-desc" style="">
        ...
        Αυτό το δωμάτιο προσφέρει μια καταπληκτική εμπειρία σε εναν τεράστιο χώρο <br>

        άνω των 85 τετραγωνικών μέτρων . Υπάρχει πληθώρα οπτικών και ακουστικών εφέ,<br>

        φυσικά εμπόδια που πρέπει να ξεπεραστούν καθώς και υψηλής ποιότητας σχέδια γεμάτα λεπτομέρειες. <br>

        Αυτό το δωμάτιο μπορεί να παιχτεί σε εκδοχές των 60 και των 90 λεπτων , και μπορεί και να περιέχει live acting.
      ...
      <p class=" story" style="">
        ...
        Τα γράμματα που λάβατε εχθές τη νύχτα, έγραφαν ακριβώς το ίδιο πράγμα, αλλά έριξαν επιτέλους φως στην υπόθεση του εδώ και 6 χρόνια εξαφανισμένου καθηγητή Robert Jackson. Και ο χάρτης που το συνόδευε σας οδήγησε βαθιά στην Αμαζονία, το λιγότερο εξερευνημένο και πιο δύσβατο κομμάτι της ζούγκλας.



        Ακολουθώντας τα στοιχεία που σας άφησε ο καθηγητής και συνεργάτης σας, καλείστε να λύσετε ένα μυστήριο για αιώνες άλυτο, ανακαλύπτοντας κάτι που θα αλλάξει την παγκόσμια ιστορία, όπως την ξέρουμε μέχρι σήμερα.
