...
<head>
  ...
  <meta name="description" content="Tutankhamun's Tomb | Αυτό το δωμάτιο είναι μια ζωντανή αναπαράσταση του εσωτερικού μιας αρχαίας Αιγυπτιακής πυραμίδας.">
...
<body id="page-top">
          ...
          <div class="" style="display: flex;justify-content: center;align-items: center;padding-bottom:40px;font-size:13px;">
            ...
            <ul class="text-left">
              ...
              <div class="lang">
                ...
                <a style="align-items:center;" href="../../it/rooms/tutankhamuns-tomb.php">Italian</a>
  ...
  <section class="container-fluid room-tut text-center " id="mainsect">
    ...
    <div class="info-container" style="">
      ...
      <p class="room-desc" style="">Αυτό το δωμάτιο είναι μια ζωντανή <br>

        αναπαράσταση του εσωτερικού μιας αρχαίας Αιγυπτιακής πυραμίδας.<br>

        Ένα εξελιγμένο σκηνοθετικά και τεχνολογικά δωμάτιο.
      ...
      <p class=" story" style="">Τώρα έχεις φτάσει στην κυρίως αίθουσα. Εάν ανοίξεις αυτή την πόρτα,

        μπορείς να ανακαλύψεις το μυστική του σπουδαίου Φαραώ. Αλλά πρόσεξε!

        Εάν παραμείνεις για περισσότερη από μια ώρα εδώ, θα υποστείς την κατάρα του για πάντα!</p>
    ...
    <div class="" style="padding-bottom: 30px;">
      ...
      <p>* Η θεματική οροφή είναι πρόσθετο χαρακτηριστικό</p>
