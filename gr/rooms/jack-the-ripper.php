...
<head>
  ...
  <meta name="description" content=" Jack The Ripper | Πίσω στο Λονδίνο του 1880, οι παίκτες παίρνουν μέρος στο κυνήγι του διαβόητου κατά συρροή δολοφόνου, του Τζακ Αντεροβγάλτη. ">
  ...
  <meta property="og:url" content="https://www.escapegameover.com/rooms/jack-the-ripper.php" />
...
<body id="page-top">
          ...
          <div class="" style="display: flex;justify-content: center;align-items: center;padding-bottom:40px;font-size:13px;">
            ...
            <ul class="text-left">
              ...
              <div class="lang">
                ...
                <a style="align-items:center;" href="../../it/rooms/jack-the-ripper.php">Italian</a>
  ...
  <section class="container-fluid room-jack text-center " id="mainsect">
    ...
    <div class="info-container" style="padding-top:50px;">
      ...
      <p class="room-desc" style="">Πίσω στο Λονδίνο του 1880, οι παίκτες παίρνουν μέρος <br>

        στο κυνήγι του διαβόητου κατά συρροή δολοφόνου, του Τζακ Αντεροβγάλτη. <br>

        Ένα τεχνολογικώς αναβαθμισμένο δωμάτιο με σπουδαία σκηνογραφία.
      ...
      <p class=" story" style="">Λονδίνο, 1888. Ακόμα ένας φόνος συνέβη αυτή την νύχτα, επίσης στη περιοχή Whitechappel. Ο Τζακ χτύπησε ξανά και οι άνθρωποι είναι τρομοκρατημένοι, ενώ σχεδόν κανένας δεν κυκλοφορεί στους δρόμους. Εκτός από σένα. Εάν τα στοιχεία που έχεις στα χέρια σου είναι σωστά, απόψε όλα θα τελειώσουν. Ή όχι; Όλα τώρα εξαρτώνται από σένα…</p>
