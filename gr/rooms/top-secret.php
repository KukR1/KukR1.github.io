...
<head>
  ...
  <meta name="description" content="Top Secret | Ένα δωμάτιο με μιλιταριστικό θέμα. Οι παίκτες πρέπει πρώτα να δραπετεύσουν από ένα κελί φυλακής και μετά από μια ολόκληρη στρατιωτική βάση, λύνοντας και τα 15 βήματα. ">
            ...
            <div class="" style="display: flex;justify-content: center;align-items: center;padding-bottom:40px;font-size:13px;">
              ...
              <div class="lang">
                  ...
                  <div class="lang">
                    ...
                    <a style="align-items:center;" href="../../it/rooms/top-secret.php">Italian</a>
                  </div>
                  <div class="lang">
...
<section class="container-fluid room-top text-center " id="mainsect">
  ...
  <div class="info-container" style="">
    ...
    <p class="room-desc" style="">Ένα δωμάτιο με μιλιταριστικό θέμα. Οι παίκτες <br>
       πρέπει πρώτα να δραπετεύσουν από ένα κελί φυλακής και μετά από μια ολόκληρη στρατιωτική βάση,<br>
        λύνοντας και τα 15 βήματα.
    </p>
