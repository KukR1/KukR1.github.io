...
<body id="page-top">
          ...
          <div class="" style="display: flex;justify-content: center;align-items: center;padding-bottom:40px;font-size:13px;">
            ...
            <ul class="text-left">
              ...
              <div class="lang">
                ...
                <a style="align-items:center;" href="../../it/rooms/philosophers-stone.php">Italian</a>
  ...
  <section class="container-fluid philosopher text-center " id="mainsect">
    ...
    <div class="info-container" style="">
      ...
      <p class="room-desc" style=""> Μια περιπέτεια παιχνιδιού διαφυγής, εμπνευσμένη από τη διάσημη κινηματογραφική σειρά.<br>

        Ένας συνδυασμός εξαιρετικά τεχνολογικά προηγμένων χαρακτηριστικών και παιχνιδιών με πολλά οπτικά εφέ, <br>φέρνουν στην πραγματικότητα μια μοναδική εμπειρία.
      ...
      <p class=" story" style="">
        ...
        Ο Αρχοντας του σκότους έχει ξυπνήσει. Μόνο η δύναμη της φιλοσοφικής λίθου, κρυμμένη μέσα σε ένα μυστικό θάλαμο

        γεμάτη από επικίνδυνα ξόρκιακαι παγίδες, μπορεί να θέσει τέρμα στην κυριαρχία του. Εσείς και η ομάδα σας

        πρέπει να ανακτήσετε την λίθο και να νικήσετε το κακό, ή όλα θα χαθούν. Βιαστείτε, γιατί ο χρόνος δεν είναι στο πλευρό σας. </p>
