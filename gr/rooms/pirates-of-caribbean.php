...
<head>
  ...
  <meta name="description" content=" Pirates Of Caribbean | Σε αυτό το δωμάτιο οι παίκτες τρυπώνουν στην καμπίνα του Μαυρογένη, μέσα στο διάσημο πλοίο Εκδίκηση της Βασίλισσας Άννας. ">
            ...
            <div class="" style="display: flex;justify-content: center;align-items: center;padding-bottom:40px;font-size:13px;">
              ...
              <div class="lang">
                  ...
                  <div class="lang">
                    ...
                    <a style="align-items:center;" href="../../it/rooms/pirates-of-caribbean.php">Italian</a>
...
<section class="container-fluid room-pirates text-center " id="mainsect">
  ...
  <div class="info-container" style="">
    ...
    <p class="room-desc" style="">Σε αυτό το δωμάτιο οι παίκτες τρυπώνουν στην καμπίνα του Μαυρογένη,<br>

       μέσα στο διάσημο πλοίο Εκδίκηση της Βασίλισσας Άννας.
...
<div class="right-icon"></div>
    ...
    <p class=" story" style="">Ενώ η «Εκδίκηση της Βασίλισσας Άννας» ήταν στην ακτή της Τορτούγα κατάφερες το αδύνατο! Είσαι στην καμπίνα του πιο σκληρού πειρατή όλων των εποχών, Εdward Thatch ( Εδουάρδου Θάτς) γνωστού και ως «Μαυρογένη». Είσαι τόσο κοντά στο πιο πολύτιμο αντικείμενο για κάθε πειρατή, αλλά η ανατολή θα φέρει τον Μαυρογένη και το πλήρωμά του, πίσω στο πλοίο!</p>
