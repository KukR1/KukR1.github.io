...
<meta property="og:url" content="https://www.escapegameover.com/rooms/la-mision-del-profesor.php" />
            ...
            <div class="" style="display: flex;justify-content: center;align-items: center;padding-bottom:40px;font-size:13px;">
              ...
              <div class="lang">
                  ...
                  <div class="lang">
                    ...
                    <a style="align-items:center;" href="../../it/rooms/la-mision-del-profesor.php">Italian</a>
...
<section class="container-fluid room-jacknew text-center " id="mainsect">
  ...
  <div  id="rooms" class="mt-5" style="display: flex;align-items: center;justify-content:center;">
    ...
    <p class="room-desc" style="">Γίνε μέλος της πιο διάσημης ομάδα κακοποιών<br> και πάρε μέρος στην μεγαλύτερη ληστεία όλων των εποχών, ληστεύοντας το Εθνικό Νομισματοκοπείο.<br> Εξουδετέρωσε την ασφάλεια και τύπωσε όσα περισσότερα χρήματα προλαβαίνει!
...
<div class="right-icon"></div>
    ...
    <p class=" story" style="">Η ώρα για την μεγαλύτερη ληστεία όλων των εποχών έχει φτάσει, βάλτε λοιπόν τις μάσκες και τις στολές σας και δείξτε τι είστε ικανοί να καταφέρετε. Το σχέδιο είναι μελετημένο στην εντέλεια και τα χρήματα σας περιμένουν, όταν όμως οι πόρτες του Νομισματοκοπείου κλείσουν η ομάδα σας θα δοκιμαστεί όπως ποτέ ξανά.
Θα μπορέσετε να παραμείνετε ενωμένοι κάτω από την ασφυκτική πίεση και τις δύσκολες επιλογές, ή θα σπάσετε και θα στραφείτε ο ένας εναντίον του άλλου; Το σχέδιο του Καθηγητή έχει ήδη τεθεί σε εφαρμογή, και ο μεγαλύτερος κίνδυνος είναι ο ίδιος σας ο εαυτός.
</p>
