...
<head>
  ...
  <meta name="description" content="Lost City Of Atlantis | Μετά από πολλά χρόνια έρευνας και μετάφρασης εκατοντάδων αρχαίων χειρογράφων, βρέθηκες εδώ!">
            ...
            <div class="" style="display: flex;justify-content: center;align-items: center;padding-bottom:40px;font-size:13px;">
              ...
              <div class="lang">
                  ...
                  <div class="lang">
                    ...
                    <a style="align-items:center;" href="../../it/rooms/lost-city-of-atlantis.php">Italian</a>
                  </div>
                  <div class="lang">
...
<section class="container-fluid room-lost text-center " id="mainsect">
  ...
  <div class="info-container" style="padding-top:50px;">
    ...
    <p class="room-desc" dstyle="">Ένα βυθισμένο τμήμα της χαμένης πόλης της Ατλαντίδας, <br>
       ένα από τα μεγαλύτερα μυστήρια όλων των εποχών.
...
<div class="right-icon"></div>
    ...
    <p class=" story" style=""> Μετά από πολλά χρόνια έρευνας και μετάφρασης εκατοντάδων αρχαίων χειρογράφων, βρέθηκες εδώ! Εάν είσαι σωστός η ανακάλυψη της Ατλαντίδας είναι ένα γεγονός που θα ξαναγράψει την παγκόσμια ιστορία, χάρις σε σένα! Τα αρχαία ερείπια που παρακολουθείς τώρα, κρύβουν μυστήρια μακράν σπουδαιότερα από όλους τους γνωστούς μύθους, και επίσης τον κίνδυνο της δικής σου εξαφάνισης μαζί με την Ατλαντίδα την ίδια!</p>
...
<p>*  Η πύλη νερού είναι προαιρετική</p>
