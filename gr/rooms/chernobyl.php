            ...
            <div class="" style="display: flex;justify-content: center;align-items: center;padding-bottom:40px;font-size:13px;">
              ...
              <div class="lang">
                  ...
                  <div class="lang">
                    ...
                    <a style="align-items:center;" href="../../it/rooms/chernobyl.php">Italian</a>
...
<section class="container-fluid room-reactor text-center " id="mainsect">
  ...
  <div class="info-container" style="">
    ...
    <p class="room-desc" style="">Μια περιπέτεια μέσα σε ένα παλιό εγκαταλελειμμένο αντιδραστήρα, <br>

      κρύβει πολλά μυστικά, γρίφους και τεχνολογία, ώστε να επιτρέψει στους παίκτες να αποδράσουν.
...
<div class="right-icon"></div>
    ...
    <p class=" story" style="">Φέτος, εσύ και οι φίλοι σου αποφασίσατε να πάτε για το ετήσιο ταξίδι διακοπών, σε ένα ξυλόσπιτο βαθιά μέσα στο δάσος της Κρακοβίας. Η πρώτη μέρα ήταν λίγο βαρετή, αλλά τότε ένας από σας ανακάλυψε έναν εγκαταλελειμμένο αντιδραστήρα στο δάσος. Απόψε είστε έτοιμοι να ζήσετε την πιο συναρπαστική περιπέτεια της ζωής σας. … έτσι διεισδύετε στο εργοστάσιο το οποίο δεν είναι τόσο εγκαταλελειμμένο όσο φαίνεται. Η περιπέτειά σας γίνεται ένας αγώνας απόδρασης από αυτό το ανατριχιαστικό μέρος όσο το δυνατόν γρηγορότερα! Προσοχή! Το διαθέσιμο οξυγόνο φαίνεται να επαρκεί για περίπου μια ώρα οπότε… βιαστείτε.</p>
