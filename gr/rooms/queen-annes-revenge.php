...
<head>
 ...
 <meta name="viewport" content="width=device-width, initial-scale=1.0, shrink-to-fit=no">
  ...
  <meta name="description" content=" Pirates - Queen Anne's Revenge | Αναπαράσταση του διαβόητου πλοίου Η Εκδίκηση της Βασίλισσας Άννας, του πειρατή Μαυρογένη.">
...
<section class="container-fluid room-pirates text-center " id="mainsect">
  ...
  <div class="text-center" style="padding-top:50px;">
    ...
    <p class="room-desc" style="">Αναπαράσταση του διαβόητου πλοίου Η Εκδίκηση της Βασίλισσας Άννας, του πειρατή Μαυρογένη. <br>
Η τεχνολογία και τα υπέροχα σετ σχεδίων και στηριγμάτων ζωντανεύουν το πλοίο.
    </p>
...
<div class="right-icon"></div>
    ...
    <p class=" story" style="">Όταν σκεφτόσασταν το σχέδιο της επιχείρησης στην ταβέρνα, όλα φαινόντουσαν λογικά και εφικτά...
Τώρα, ενώ στέκεστε στον κόλπο της Τορτούγκα τα μεσάνυχτα και την κοιτάζετε με τις ψυχές σας γεμάτες φόβο, τίποτα δεν μοιάζει λογικό.
Είστε τόσο κοντά στο πιο πολύτιμο αντικείμενο του κόσμου ενός Πειρατή, όμως κανείς δεν κατάφερε στο παρελθόν να ανέβει στην Εκδίκηση της Βασίλισσας Άννας και να γυρίσει ώστε να πει την ιστορία.
Ξέρετε ότι τα μεσάνυχτα, ο Μαυρογένης και το πλήρωμα του θα επιστρέψουν στο πλοίο. Τώρα έχετε τη μοναδική σας ευκαιρία...<br>
Προχωρήστε!
    </p>
  </div>
