...
<head>
  ...
  <meta name="description" content="Phantazma - Medieval castle | Φήμες και θρύλοι σε οδήγησαν εδώ! Τα ημερολόγια αυτών που προσπάθησαν πριν από σένα σταματούν εδώ.">
            ...
            <div class="" style="display: flex;justify-content: center;align-items: center;padding-bottom:40px;font-size:13px;">
              ...
              <div class="lang">
                  ...
                  <div class="lang">
                    ...
                    <a style="align-items:center;" href="../../it/rooms/phantazma.php">Italian</a>
...
<section class="container-fluid room-phantazma text-center " id="mainsect">
  ...
  <div class="info-container" style="padding-top:50px;">
    ...
    <p class="room-desc" style="">Αυτό το δωμάτιο μπορεί να γίνει παροχή σε δύο διαφορετικές <br>

      εκδόσεις. Το Μεσαιωνικό κάστρο έχει να κάνει με μεσαιωνική ιστορία σε <br>

       ένα μυστηριώδες κάστρο. Το Φάντασμα είναι ένας σκοτεινός τρομακτικός <br>

       εγκαταλελειμμένος πύργος με πολλές περίεργες φήμες γύρω του.<br>

        Μπορεί επίσης να συμπεριλάβει και ένα ζωντανό θεατρικό ρόλο.
...
<div class="right-icon"></div>
    ...
    <p class=" story" style="">Φήμες και θρύλοι σε οδήγησαν εδώ! Τα ημερολόγια αυτών που προσπάθησαν πριν από σένα σταματούν εδώ, θυμάσαι; Από το Salah ed Din’s Citadel προχώρησαν στην έρημο, σε ένα πυργο παρατηρητήριο, όπου ο μύθος λέει ότι ο τελευταίος ιδρυτής του Τάγματος του Ναού των Ιπποτών εξαφανίστηκε! Κανένας δεν επέστρεψε για να επιβεβαιώσει τις ιστορίες… Όταν φαίνεται το φεγγάρι τα καραβάνια της ερήμου βλέπουν φώτα από ένα μίλι μακριά και αποκαλούν τον πύργο στοιχειωμένο, αλλά οι ηλικιωμένοι ακόμα πιστεύουν ότι ο Σταυροφόρος ήταν δαίμονας και είναι ακόμα ΖΩΝΤΑΝΟΣ!</p>
