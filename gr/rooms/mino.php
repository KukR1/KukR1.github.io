...
<head>
  ...
  <meta name="description" content=" Minotaur's Labyrinth | Αυτό το δωμάτιο είναι αναπαράσταση του Λαβυρίνθου του Βασιλιά Μίνωα στην αρχαία Κρήτη.">
            ...
            <div class="" style="display: flex;justify-content: center;align-items: center;padding-bottom:40px;font-size:13px;">
              ...
              <div class="lang">
                  ...
                  <div class="lang">
                    ...
                    <a style="align-items:center;" href="../../it/rooms/mino.php">Italian</a>
...
<section class="container-fluid room-mino text-center " id="mainsect">
  ...
  <div class="info-container" style="padding-top:50px;">
    ...
    <p class="room-desc" style="">Αυτό το δωμάτιο είναι αναπαράσταση του Λαβυρίνθου <br>

      του Βασιλιά Μίνωα στην αρχαία Κρήτη. Ένα πολύ δημοφιλές θέμα <br>

       της Ελληνικής μυθολογίας, με προκλητικά δύσκολη δράση αποτελούμενη από 19 σκαλοπάτια.</p>
...
<div class="right-icon"></div>
    ...
    <p class=" story" style=""> Συγχαρητήρια! Έσωσες τη ζωή σου σκοτώνοντας τον θηριώδη Μινώταυρο αλλά αυτή δεν ήταν η δυσκολότερη πρόκληση. Τώρα έχεις μια ώρα να βρεις την έξοδο του λαβυρίνθου πριν ο Βασιλιάς Μίνωας έρθει με τους στρατιώτες του.
