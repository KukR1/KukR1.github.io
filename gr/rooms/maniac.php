...
<head>
  ...
  <meta name="description" content="Maniac: I Want To Play a Game | Εμπνευσμένο από την διάσημη σειρά ταινιών, αυτό το δωμάτιο θα ξυπνήσει όλα τα ένστικτα επιβίωσής σας. ">
  ...
  <meta property="og:url" content="https://www.escapegameover.com/rooms/maniac.php" />
            ...
            <div class="" style="display: flex;justify-content: center;align-items: center;padding-bottom:40px;font-size:13px;">
              ...
              <div class="lang">
                  ...
                  <div class="lang">
                    ...
                    <a style="align-items:center;" href="../../it/rooms/maniac.php">Italian</a>
...
<section class="container-fluid room-maniac text-center " id="mainsect">
  ...
  <div class="info-container" style="padding-top:50px;">
    ...
    <p class="room-desc">Εμπνευσμένο από την διάσημη σειρά ταινιών, <br>

       αυτό το δωμάτιο θα ξυπνήσει όλα τα ένστικτα επιβίωσής σας.</p>
...
<div class="right-icon"></div>
    ...
    <p class=" story">Ξυπνάς σε ένα σκοτεινό μέρος, που μπορείς να δείς ... Το μόνο πράγμα που μπορείς να αισθανθείς είναι μια φωνή από το τίποτα : «Θέλω να παίξω ένα παιχνίδι…». Έχεις εμπλακεί στην περίπτωση του λαβύρινθου και γνωρίζεις πως όλα είναι εναντίον σου. Η μοναδική σου ευκαιρία να επιζήσεις είναι να ακολουθήσεις τις τρελές αποστολές του και να βρεις την κατάλληλη στιγμή να αποδράσεις! Ο χρόνος τρέχει…</p>
