            ...
            <div class="" style="display: flex;justify-content: center;align-items: center;padding-bottom:40px;font-size:13px;">
              ...
              <div class="lang">
                  ...
                  <div class="lang">
                    ...
                    <a style="align-items:center;" href="../../it/rooms/walking-death.php">Italian</a>
  ...
  <div class="info-container" style="">
    ...
    <div   id="rooms" style="display: flex;align-items: center;justify-content:center;padding-top:50px;">
      ...
      <h1 style="display:inline-block;line-height:5rem;font-size:3rem;">WALKING DEATH</h1>
        ...
        <p class="room-desc" style="">Έχουν περάσει δύο χρόνια από την έναρξη της Αποκάλυψης.<br>



Η ανθρωπότητα εξαφανίζεται, αλλά εξακολουθούν να υπάρχουν επιζώντες,<br>

αναζητώντας ένα καταφύγιο για να κρυφτουν από τα ζόμπι.
...
<div class="right-icon"></div>
    ...
    <p class=" story" style="">Η ομάδα σας έχει επιζήσει από την κόλαση, πρέπει να αγωνιστεί όχι μόνο εναντίον των νεκρών αλλά και των εχθρικών ανθρώπινων πυρήνων.

Πριν από μία εβδομάδα βρήκατε αυτήν την εγκαταλελειμμένη φυλακή. Ήσασταν τυχεροί εξαλείφοντας τα λίγα ζόμπι που είχαν απομείνει εκεί.

Τώρα προσπαθείτε να εγκαταστήσετε έναν οικισμό, επισκευάζοντας τις οχυρώσεις και εξερευνώντας βήμα προς βήμα κάθε τμήμα.

Σήμερα, στην ενότητα 3, ο τομέας απομόνωσης είναι ο στόχος σας ...</p>
