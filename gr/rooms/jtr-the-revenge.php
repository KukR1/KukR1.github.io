...
<head>
  ...
  <meta name="description" content="Jack The Ripper The Revenge | Πίσω στο Λονδίνο του 1880, οι παίκτες παίρνουν μέρος στο κυνήγι του διαβόητου κατά συρροή δολοφόνου, του Τζακ Αντεροβγάλτη. ">
         ...
         <button class="closebtn" >&times;</button>
            ...
            <div class="" style="display: flex;justify-content: center;align-items: center;padding-bottom:40px;font-size:13px;">
              ...
              <div class="lang">
                    ...
                    <a href="../../rooms/jtr-the-revenge.php">English</a>
                  ...
                  <div class="lang">
                    ...
                    <a style="align-items:center;" href="../../it/rooms/jtr-the-revenge.php">Italian</a>
...
<?php include '../../inc/carousel-jtr-the-revenge.php'; ?>
...
<section class="container-fluid room-jacknew text-center " id="mainsect">
  ...
  <div class="info-container" style="">
    ...
    <p class="room-desc" style="">Πίσω στο Λονδίνο του 1880, οι παίκτες παίρνουν μέρος <br>
      ...
      Ένα δωμάτιο με σπουδαία σκηνογραφία και επίσης τεχνολογικώς αναβαθμισμένο.
    ...
    <div class="room-icon" style="">
        ...
        <div class="small-box text-center" style="">
          ...
          <p class="pdesc">120m<sup>2</sup></p>
