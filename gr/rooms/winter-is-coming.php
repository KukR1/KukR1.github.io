          ...
          <div class="" style="display: flex;justify-content: center;align-items: center;padding-bottom:40px;font-size:13px;">
            ...
            <ul class="text-left">
              ...
              <div class="lang">
                ...
                <a style="align-items:center;" href="../../it/rooms/winter-is-coming.php">Italian</a>
  ...
  <section class="container-fluid room-winter text-center " id="mainsect">
    ...
    <div class="info-container" style="">
      ...
      <p class="room-desc" style="">
        ...
        Η ιστορία διαδραματίζεται στην διάσημη τηλεοπτικό σειρά Game of Thrones του Castle Black <br>

        και η αποστολή σας είναι να σώσετε τον κόσμο από τους νεκρούς.<br>

        Ένα πολύ σκηνογραφικά και τεχνολογικά προηγμένο δωμάτιο.
      ...
      <p class=" story" style="">Οι White Walkers διασχίζουν το Τοίχος και είναι παντού! Ο κόσμος έχει έναν νέο εχθρό και

        το χειρότερο? Φαίνεται ανίκητος! Η μόνη ελπίδα που απομένει είναι ένα παλιό χειρόγραφο του Grand Maester για ένα όπλο κατά του χειμώνα που είναι κρυμμένο στον τοίχο του πάγου! Εκπρόσωποι από όλα τα μεγάλα σπίτια έχουν συγκεντρωθεί στο Castle Black αλλά δεν κατάφεραν να βρουν τίποτα ... Αλλά ίσως η αίθουσα κρύβει περισσότερο από ό, τι φαίνεται;</p>
