...
<head>
  ...
  <meta name="description" content="Necromancy | Κάπου στην πόλη, υπάρχει ένα παλιό σπίτι το οποίο όλοι αποφεύγουν .">
...
<div class="right-icon"></div>
    ...
    <p class=" story" style="">Κάπου στην πόλη, υπάρχει ένα παλιό σπίτι το οποίο όλοι αποφεύγουν . Tα πνεύματα που υπάρχουν φυλακισμένα εκεί είναι αιώνια βυθισμένα σε έναν εφιάλτη δίχως τέλος. Εσείς όμως θα πρέπει, όχι μόνο να εξερευνήσετε το παλιό αρχοντικό, αλλά και να καλέσετε τις χαμένες ψυχές από τον μακάβριο λήθαργο τους, ακόμα και αν αυτό σημαίνει ότι θα εξασκήσετε την απαγορευμένη τέχνη της Νεκρομαντείας. Το τι θα ανακαλύψετε εκεί μέσα δεν το γνωρίζει κανείς, καθώς κανείς δεν έχει επιστρέψει από το σπίτι αυτό ζωντανός – ή έστω απέθαντος…</p>
...
<p style="font-weight:500;">*  Το δωμάτιο απαιτεί live acting</p>
