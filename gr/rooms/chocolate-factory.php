...
<head>
  ...
  <meta name="description" content="Chocolate Factory | Ένα μυστήριο για ενήλικες και παιδιά.">
            ...
            <div class="" style="display: flex;justify-content: center;align-items: center;padding-bottom:40px;font-size:13px;">
              ...
              <div class="lang">
                  ...
                  <div class="lang">
                    ...
                    <a style="align-items:center;" href="../../it/rooms/chocolate-factory.php">Italian</a>
...
<section class="container-fluid room-choco text-center " id="mainsect">
  ...
  <div class="info-container" style="padding-top:50px;">
    ...
    <p class="room-desc" style="">Ένα μυστήριο για ενήλικες και παιδιά. <br>

       Τρύπωσε σε ένα εργοστάσιο σοκολάτας, χρησιμοποίησε όλες σου τις αισθήσεις, <br>

        θέσε σε λειτουργία την μηχανή να κερδίσεις τον χρόνο και να διεκδικήσεις την πολύτιμη συνταγή
    ...
    <div class="room-icon" style="">
        ...
        <div class="small-box text-center" style="">
          ...
          <img src="../../img/menus_logo/scenarios.svg" width="30px" >
...
<div class="right-icon"></div>
    ...
    <p class="story" style="">Για πολλά χρόνια έχει κρατηθεί ως σπουδαίο μυστικό. Φήμες λένε ότι υπάρχει μια σπουδαία χειροποίητη μηχανή που δίνει αυτή τη μαγική γεύση στις σοκολάτες τους. Όλα αυτά μέχρι σήμερα, επειδή εσύ και η ομάδα σου είστε αποφασισμένοι να τρυπώσετε στο απαγορευμένο δωμάτιο στο μεγαλύτερο εργοστάσιο σοκολάτας της Ελβετίας! Σκοπός σας είναι να βρείτε πως δουλεύει η μηχανή, να τη θέσετε σε λειτουργία και να κλέψετε τη μυστική συνταγή από την καλύτερη σοκολάτα που έχει φτιάξει ποτέ ανθρώπινο χέρι.</p>
