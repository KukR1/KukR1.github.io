            ...
            <div class="" style="display: flex;justify-content: center;align-items: center;padding-bottom:40px;font-size:13px;">
              ...
              <div class="lang">
                  ...
                  <div class="lang">
                    ...
                    <a style="align-items:center;" href="../../it/rooms/montezuma.php">Italian</a>
...
<section class="container-fluid room-monte text-center " id="mainsect">
  ...
  <div class="info-container" style="padding-top:50px;">
    ...
    <p class="room-desc" style="">Το δωμάτιο είναι μια αληθινή αναπαράσταση ενός αρχαίου ναού των Αζτέκων στην ζούγκλα.<br>

       Δελεαστική δράση, πολύ τεχνολογία στα παρασκήνια και επίσης υψηλής ποιότητας θεματική σκηνογραφία <br>

       κάνουν αυτό το δωμάτιο μοναδικό
...
<div class="right-icon"></div>
    ...
    <p class=" story" style="">Πάνε πολλά χρόνια από τότε που ο καθηγητής σου στο Αρχαιολογικό Πανεπιστήμιο εξαφανίστηκε. Είχατε υποσχεθεί ο ένας στον άλλον να φέρετε την έρευνά του για τους Αζτέκους στην δημοσιότητα! Έτσι τώρα είσαι εδώ, ακολουθώντας τα αριστοτεχνικά κρυπτογραφημένα ίχνη... Αλλά πρόσεχε.. Οτιδήποτε προκάλεσε την εξαφάνισή του ίσως επιδιώξει το ίδιο και σε σένα…
