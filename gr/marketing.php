...
<head>
  ...
  <title>Marketing | GAME OVER Escape Rooms </title>
            ...
            <div class="" style="display: flex;justify-content: center;align-items: center;padding-bottom:40px;font-size:13px;">
              ...
              <div class="lang">
                  ...
                  <div class="lang">
                    ...
                    <a style="align-items:center;" href="../it/marketing.php">Italian</a>
                  ...
                  <div class="lang">
                    ...
                    <a href="../de/marketing.php">German</a>
...
<section id="marketing_main1" class="container-fluid text-center">
  ...
  <img style=" opacity: 0.7; " src="../img/construction/bg.png" alt="">
    ...
    Επιλέγοντας να συνεργαστείτε με το brand της GAME OVER Escape Rooms,<br class="display-items">

 θα σας παρέχεται εξειδικευμένη τεχνική υποστήριξη και υποστήριξη marketing.

     <br><br>

  Ολές σας οι ανάγκες σχετικά με προωθητικό υλικό καλύπτονται από το τμήμα σχεδιασμού μας.



     <br class="display-items">

    Θα αποκτήσετε άμεση πρόσβαση στο βασικό μας πακέτο για την διαφημισή σας. Εκτυπώσιμα ή ψηφιακά γραφιστικά

      θα είναι διαθέσιμα ανά πάσα στιγμή, ανάλογα με την καμπάνια σας,

     σύμφωνα με τα παγκόσμια πρότυπα marketing.

     <br><br>



Επίσης, όλα τα αιτήματά σας σχετικά με την διαδικτυακή σας υποστήριξη θα καλυφθούν από το τμήμα πληροφορικής μας.
...
<section id="technical-list" class="container-fluid " style="text-align:center;">
    ...
    <ul class="" style="">
      ...
      <li><p>Φιλοξενία Iστοσελίδας</p><span></span></li>

      <li><p>Ονομα Domain</p><span></span></li>

      <li><p>Πιστοποιητικό ιστοσελίδας SSL</p><span></span></li>

      <li><p>Δίγλωσση Ιστοσελίδα </p><span></span></li>

      <li><p>Σύστημα Κρατήσεων </p><span></span></li>

      <li><p>Πρόσβαση στο GAME OVER Cloud</p><span></span></li>

      <li><p>Λογαριασμοί Email</p><span></span></li>

      <li><p>Αναβαθμίσεις Ιστοδελίδας</p><span></span></li>

      <li><p>Εξειδικευμένη υποστήριξη ΙΤ</p><span></span></li>

      <li><p>Βασικό Πακέτο Marketing </p><span></span></li>

      <li><p>Εκτυπώσιμο Διαφημιστικό Υλικό</p><span></span></li>

      <li><p>Εξειδικευμένη Υποστήριξη Γραφιστικών Υπηρεσιών</p><span></span></li>

      <li><p>Υλικό για Μέσα Κοινωνικής Δικτύωσης</p><span></span></li>

      <li><p>Βελτιστοποίηση Ιστοσελίδων για Κινητά</p><span></span></li>
    ...
    <img src="../img/construction/stuff.png" alt="" style="width:330px;">
