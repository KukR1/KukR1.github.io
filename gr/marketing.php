  ...
  <section id="technical-list" class="container-fluid " style="text-align:center;">
    ...
    <div class='left-div'>
      ...
      <ul class="" style="">
        ...
        <li>
          <p>Φιλοξενία Iστοσελίδας</p><span></span>
        </li>

        <li>
          <p>Ονομα Domain</p><span></span>
        </li>

        <li>
          <p>Πιστοποιητικό ιστοσελίδας SSL</p><span></span>
        </li>

        <li>
          <p>Δίγλωσση Ιστοσελίδα </p><span></span>
        </li>

        <li>
          <p>Σύστημα Κρατήσεων </p><span></span>
        </li>

        <li>
          <p>Πρόσβαση στο GAME OVER Cloud</p><span></span>
        </li>

        <li>
          <p>Λογαριασμοί Email</p><span></span>
        </li>

        <li>
          <p>Αναβαθμίσεις Ιστοδελίδας</p><span></span>
        </li>

        <li>
          <p>Εξειδικευμένη υποστήριξη ΙΤ</p><span></span>
        </li>

        <li>
          <p>Βασικό Πακέτο Marketing </p><span></span>
        </li>

        <li>
          <p>Εκτυπώσιμο Διαφημιστικό Υλικό</p><span></span>
        </li>

        <li>
          <p>Εξειδικευμένη Υποστήριξη Γραφιστικών Υπηρεσιών</p><span></span>
        </li>

        <li>
          <p>Υλικό για Μέσα Κοινωνικής Δικτύωσης</p><span></span>
        </li>

        <li>
          <p>Βελτιστοποίηση Ιστοσελίδων για Κινητά</p><span></span>
        </li>
