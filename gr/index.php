      ...
      <div class="burger-flag" style="">
         ...
         <div class="dropup-container">
            <div class="dropup" style="" onclick="openNav()">
               <img class="dropbtn" style="width:25px;" src="../img/flags/select.svg" alt="Επιλογή γλώσσας">
               ...
               <div class="" style="display: flex;justify-content: center;align-items: center;padding-bottom:40px;font-size:13px;">
                  <ul class="text-left">
                     ...
                     <div class="lang">
                        ...
                        <a style="align-items:center;" href="../it/index.php">Italian</a>
                     </div>
                     <div class="lang">
...
<a class="js-scroll-trigger" href="#sect1">
   ...
   <section id="sect1" class=" container-fluid text-center">
      <div class="second-box">
         <img src="../img/menus_logo/aboutus.svg" alt="ΕΛΑΤΕ ΜΑΖΙ ΜΑΣ" style="width:45px;height:45px;">
         <h2>ΕΛΑΤΕ ΜΑΖΙ ΜΑΣ</h2>
         <div class="paragraph-container">
            <p class="fade1 fadeIn animated">Τα GAME OVER Escape Rooms σχεδιάζουν και παράγουν ανωτέρας ποιότητας,<br>
               πλήρως θεματικά, μοναδικά παιχνίδια απόδρασης </p>
            <p class="fade2 fadeIn animated inv">Μπορούν να προσφερθούν στον δυνητικό αγοραστή, είτε χρησιμοποιώντας την δική μας επωνυμία GAME OVER και τις προοπτικές που προκύπτουν από μια μόνιμη συνεργασία, ή μόνο τα δωμάτια που δημιουργεί το GAME OVER, χρησιμοποιώντας την επωνυμία του αγοραστή.Σαν αποτέλεσμα της επίμονης έρευνας στοχεύοντας στην καινοτομία στον τομέα μας και στο εξαιρετικό σχέδιο μάρκετινγκ που χαρακτηρίζει την επωνυμία μας Game over, σας προσκαλούμε να μας ακολουθήσετε σε μια φιλόδοξη και επικερδή καριέρα.

               Αναζητούμε συνεργάτες σε όλο τον κόσμο, ώστε να αναπτύξουμε το δίκτυο μας και την εμπειρία των escape rooms.</p>
   ...
   <section id="sect2" class="container-fluid text-center">
      <div class="second-box">
         <img src="../img/menus_logo/search.svg" alt="ΣΧΕΤΙΚΑ ΜΕ ΤΑ ESCAPE ROOMS" style="width:45px;height:45px;">
         <h2>ΣΧΕΤΙΚΑ ΜΕ ΤΑ ESCAPE ROOMS</h2>
         <div class="paragraph-container">
            <p class="fade1 fadeIn animated">Τα δωμάτια απόδρασης είναι διαδραστικά, εξαιρετικά συναρπαστικά <br>
               παιχνίδια όπου αναθέτουν σε κάποιον ένα ρόλο σύμφωνα με το σενάριο.</p>
            <p class="fade2 fadeIn animated inv">Ο στόχος του παιχνιδιού είναι να λύσουν έναν αριθμό γρίφων, να βρούν κρυμμένα αντικείμενα και στοιχεία έτσι ώστε να μπορέσουν οι παίκτες να λύσουν το μυστήριο και να δραπετεύσουν από το δωμάτιο έγκαιρα.



               Τα δωμάτια απόδρασης έχουν γίνει μόδα διεθνώς στην διασκέδαση τα τελευταία χρόνια, και οι οπαδοί αυτού του παιχνιδιού που το συμπεριλαμβάνουν στην καθημερινή τους διασκέδαση ονομάζονται escape gamers.</p>
         </div>
         <div class="text-center" style="margin:10px 0;">
   ...
   <section class="  container-fluid text-center" id="scenarios">
      <img src="../img/menus_logo/scenarios.svg" alt="ΣΕΝΑΡΙΑ" style="width:45px;height:45px;">
      <h2>ΣΕΝΑΡΙΑ</h2>
                  ...
                  <div class="row">
                     <div class='col-md-3 col-12'>
                        <div class="image-box" title="">
                           <!-- THIS IS CHOCOLATE -->
                           <picture>
                              <source type="image/jpeg" srcset="../img/mobile_thumbs/choco.webp" media="(max-width: 767px)">
   ...
   <section id="whatwedo" class="lazy container-fluid text-center">
      ...
      <div class="" style="display:flex;width:100%;align-items:center;justify-content:center;">
         <div class="third-box">
            ...
            <h2>ΤΙ ΠΡΟΣΦΕΡΟΥΜΕ</h2>

            <p style="margin: 0 0 1.1rem;letter-spacing: 0.9px;">Ολοκληρωμένες κατασκευές και προνόμια marketing </p>
      ...
      <div class="container-fluid whatwedo-container" style="">
         <div class=" text-center offer-box">
            ...
            <p>Σχεδιάζουμε και δημιουργούμε ανωτέρας ποιότητας θεματικά δωμάτια απόδρασης.</p>
         </div>
         <div class=" text-center offer-box">
            <a href="gallery.php">
               <div class="">
            ...
            <p>Είμαστε διαθέσιμοι σε οποιαδήποτε χώρα σε όλο τον κόσμο.</p>
         </div>
         <div class=" text-center offer-box">
            ...
            <p>Δωρεάν εκπαίδευση και διαδικασίες για τα παιχνίδια, αναδιάταξη, συντήρηση των δωματίων.</p>
         </div>
         <div class=" text-center offer-box">
            <div class="">

            </div>
            <p>Εάν έχετε ερωτήσεις προβλήματα ή προτάσεις μπορείτε να μας τηλεφωνήσετε ή να μας στείλετε email οποιαδήποτε στιγμή.</p>
         </div>
         <div class=" text-center offer-box">
            <div class="">

            </div>
            <p>Δωρεάν αναβαθμίσεις: σε περίπτωση που δεν σας αρέσει κάποιο τρικ ή γρίφος στο παιχνίδι, εμείς θα το αλλάξουμε.</p>
         </div>
         <div class=" text-center offer-box">
            <a href="autohelp.php">
               <div class="">
            ...
            <p>Το Autohelp Hint System είναι ένας αυτοματοποιημένος τρόπος για να ελέγχετε και να καθοδηγείτε τους παίκτες μέσα στο δωμάτιο χωρίς την χρήση ενός Game Master για τη λειτουργία κάθε δωματίου.</p>
         </div>
         <div class=" text-center offer-box">
            <div class="">

            </div>
            <p>Μπορείτε να χρησιμοποιήσετε το δικό σας λογότυπο και εμπορική ονομασία ή να χρησιμοποιήσετε έτοιμο πακέτο εταιρικής ταυτότητας και μάρκετινγκ.</p>
         </div>
         <div class=" text-center offer-box">
            <div class="">

            </div>
            <p>Η συμμετοχή σας στις υπηρεσίες μάρκετινγκ σας προσφέρει εξαιρετική IT και αφοσιωμένη Artwork υποστήριξη.</p>
         </div>
      </div>
         ...
         <div class="ul-container" style="display:flex;    width: 100%;">
            <div class="footer-flex" style="">
               ...
               <ul class="company1" style="text-align:right;">
                  <li class="site-li-header">ΕΛΑΤΕ ΜΑΖΙ ΜΑΣ</li>
            ...
            <div class="footer-flex2" id="foot-dest">
               <ul class="contact1" style="text-align:left;">
                  <li class="site-li-header">ΕΠΙΚΟΙΝΩΝΙΑ</li>
