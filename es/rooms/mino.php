...
<head>
  ...
  <meta name="description" content=" Minotaur's Labyrinth | Esta sala es una representación del laberinto del rey Minos en la antigua Creta.
     Un tema muy popular de la<br> mitología griega con un juego de desafío que consiste en 19 pasos.">
  ...
  <meta property="og:url" content="https://www.escapegameover.com/es/rooms/mino.php" />
...
<section class="container-fluid room-mino text-center " id="mainsect">
  ...
  <div class="info-container" style="padding-top:50px;">
    ...
    <p class="room-desc" style="">Esta sala es una representación del laberinto<br> del rey Minos en la antigua Creta.
       Un tema muy popular de la<br> mitología griega con un juego de desafío que consiste en 19 pasos
    </p>
...
<div class="right-icon"></div>
    ...
    <p class=" story" style="">¡Felicitaciones! Salvasteis vuestra vida porque matasteis
      al feroz Minotauro, pero ese no era el desafío más difícil.
       Ahora contáis con una (1) hora para encontrar la salida del laberinto antes de que el rey Minos llegue con los soldados.
