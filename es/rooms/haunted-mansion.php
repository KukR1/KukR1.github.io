...
Sound and Visual effects combination increase the player’s experience. "> <meta property="og:locale" content="es_ES" />
  ...
  <meta property="og:url" content="https://www.escapegameover.com/es/rooms/haunted-mansion.php" />
...
<section class="container-fluid room-choco text-center " id="mainsect">
  ...
  <div id="rooms" class="mt-5" style="display: flex;align-items: center;justify-content:center;">
    ...
    Una habitación de terror, con una atmósfera intensa y sustos de miedo.<br>
La combinación de efectos de sonido e imagen aumenta la experiencia del jugador.
...
<div class="right-icon"></div>
    ...
    <p class=" story" style="">
    Sos un equipo de los más experimentados «investigadores de lo sobrenatural». Un hombre misterioso se acercó y te ofreció una enorme cantidad de dinero para entrar y buscar un poderoso objeto antiguo. No omitió decir que el último que contrató nunca regresó.
    </p>
  </div>
